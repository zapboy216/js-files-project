    ...
    902: (at, Bt, d) => {
        ...
        class o {
          ...
          ngOnInit() {
            this.configurationService.getApplicationConfiguration().subscribe(
              (e) => {
                var n;
                null !== (n = null == e ? void 0 : e.application) &&
                  void 0 !== n &&
                  n.altcoinName &&
        ...
        return (
          ...
          (o.ɵcmp = t.Xpm({
            ...
            template: function (e, n) {
              1 & e &&
                (t.TgZ(0, "mat-card")(1, "div", 0)(2, "div", 1)(
                  3,
                  "mat-card-header"
                )(4, "mat-card-title"),
                t._uU(5),
                ...
                t.qZA()()(),
                t.TgZ(64, "div", 16)(65, "mat-card-header")(
                  66,
                  "mat-card-title",
                  17
                ),
                ...
                t._uU(
                  82,
                  " sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. "
                ),
                t.qZA()(),
                ...
                2 & e &&
                  ...
                  t.Q6J(
                    "innerHtml",
                    t.xi3(8, 14, "SECTION_ICO", t.VKq(22, Jt, n.altcoinName)),
                    t.oJD
                  ),
                  t.xp6(5),
      ...
      let Ue = (() => {
          class o {
            ...
            ngOnInit() {
              var e = this;
              this.userService
                .oauthLogin(this.parseRedirectUrlParams().access_token)
                .subscribe(
                  (n) => {
                    const i = btoa(n.email.split("").reverse().join(""));
                    this.userService
                      .save({ email: n.email, password: i, passwordRepeat: i })
                      .subscribe(
                        () => {
                          this.login(n);
                        },
                ...
                .subscribe(
                  (i) => {
                    ...
                    r.setHours(r.getHours() + 8),
                      this.cookieService.put("token", i.token, { expires: r }),
          ...
          return (
            ...
            (o.ɵcmp = t.Xpm({
              ...
              template: function (e, n) {
                1 & e &&
                  (t.TgZ(0, "div", 0)(1, "mat-card", 1)(2, "div")(3, "h3"),
                  t._uU(4),
                  t.ALo(5, "translate"),
                  t.qZA(),
                  t.TgZ(6, "div"),
          ...
          class o {
            ...
            updateNumberOfCartItems() {
              this.find(parseInt(sessionStorage.getItem("bid"), 10)).subscribe(
                (e) => {
                  this.itemTotal.next(
                    e.Products.reduce((n, i) => n + i.BasketItem.quantity, 0)
                  );
                },
                (e) => console.log(e)
              );
          ...
          class o {
            ...
            canActivate() {
              return (
                ...
                (this.forbidRoute("UNAUTHORIZED_ACCESS_ERROR"), !1)
              );
            }
        ...
        Gt = (() => {
          class o {
            ...
            canActivate() {
              ...
              return (
                !(!(null == e ? void 0 : e.data) || "admin" !== e.data.role) ||
                (this.loginGuard.forbidRoute(), !1)
              );
            }
          }
          return (
        ...
        jt = (() => {
          class o {
            ...
            canActivate() {
              ...
              return (
                !(
                  !(null == e ? void 0 : e.data) || "accounting" !== e.data.role
                ) || (this.loginGuard.forbidRoute(), !1)
              );
            }
          }
      ...
      let M = (() => {
        class o {
          ...
          open(e, n) {
            this.translateService.get(e).subscribe(
              (i) => {
                this.snackBar.open(i, "X", { duration: 5e3, panelClass: n });
              },
              () => {
                this.snackBar.open(e, "X", { duration: 5e3, panelClass: n });
              }
            );
          }
        }
      ...
      function Oe(o, a) {
        if (
          (1 & o && (t.TgZ(0, "mat-cell", 20), t._UZ(1, "img", 21), t.qZA()),
          2 & o)
        ) {
          const e = a.$implicit;
          t.xp6(1),
      ...
      function Fe(o, a) {
        if (
          (1 & o &&
            (t.TgZ(0, "mat-cell", 24),
            t.YNc(1, Me, 2, 0, "button", 25),
            t.TgZ(2, "span", 26),
            t._uU(3),
            t.qZA(),
            t.YNc(4, De, 2, 0, "button", 25),
            t.qZA()),
          2 & o)
        ) {
          const e = a.$implicit,
      ...
      function je(o, a) {
        1 & o &&
          (t.ynx(0, 33),
          t.YNc(1, Qe, 1, 0, "mat-header-cell", 2),
          t.YNc(2, He, 3, 0, "mat-cell", 34),
          t.YNc(3, Ge, 1, 0, "mat-footer-cell", 35),
          t.BQk());
      }
      function ze(o, a) {
      ...
      function $e(o, a) {
        if (
          (1 & o &&
            (t.TgZ(0, "span"),
            t.YNc(1, We, 1, 0, "mat-footer-row", 38),
            t.qZA()),
          2 & o)
        ) {
          const e = t.oxw();
      ...
      function Ve(o, a) {
        if (
          (1 & o &&
            (t.TgZ(0, "div", 40), t._uU(1), t.ALo(2, "translate"), t.qZA()),
          2 & o)
        ) {
          const e = t.oxw();
          t.xp6(1),
          ...
          load() {
            this.basketService
              ...
              .subscribe(
                (e) => {
                  this.isDeluxe() &&
                    e.Products.forEach((n) => {
                      n.price = n.deluxePrice;
                    }),
                    (this.dataSource = e.Products),
                    (this.itemTotal = e.Products.reduce(
                      (n, i) => n + i.price * i.BasketItem.quantity,
                      0
                    )),
                    (this.bonus = e.Products.reduce(
                      (n, i) =>
          ...
          (o.ɵcmp = t.Xpm({
            ...
            template: function (e, n) {
              1 & e &&
                ...
                t.TgZ(5, "mat-table", 0),
                t.ynx(6, 1),
                t.YNc(7, ke, 1, 0, "mat-header-cell", 2),
                t.YNc(8, Oe, 2, 2, "mat-cell", 3),
                t.YNc(9, Pe, 1, 0, "mat-footer-cell", 4),
                t.BQk(),
                t.ynx(10, 5),
                t.YNc(11, Le, 1, 0, "mat-header-cell", 2),
                t.YNc(12, Ne, 2, 1, "mat-cell", 6),
                t.YNc(13, Ee, 1, 0, "mat-footer-cell", 7),
                t.BQk(),
                t.ynx(14, 8),
                t.YNc(15, qe, 1, 0, "mat-header-cell", 2),
                t.YNc(16, Fe, 5, 3, "mat-cell", 9),
                t.YNc(17, Re, 2, 0, "mat-footer-cell", 10),
                t.BQk(),
                t.ynx(18, 11),
                t.YNc(19, Ye, 1, 0, "mat-header-cell", 2),
                t.YNc(20, Be, 2, 1, "mat-cell", 12),
                t.YNc(21, Je, 1, 0, "mat-footer-cell", 13),
                t.BQk(),
                t.YNc(22, je, 4, 0, "ng-container", 14),
                t.YNc(23, ze, 1, 0, "mat-header-row", 15),
                t.YNc(24, Ke, 1, 0, "mat-row", 16),
                t.YNc(25, $e, 2, 1, "span", 17),
                t.qZA(),
                t.YNc(26, Ve, 3, 4, "div", 18)),
                2 & e &&
                  (t.xp6(1),
      ...
      let to = (() => {
          ...
          return (
            ...
            (o.ɵcmp = t.Xpm({
              ...
              template: function (e, n) {
                1 & e &&
                  (t.TgZ(0, "mat-card", 0)(1, "app-purchase-basket", 1),
      ...
      function co(o, a) {
        1 & o &&
          (t.TgZ(0, "mat-header-cell", 1), t._uU(1, "LABEL_PRODUCT"), t.qZA());
      }
      function uo(o, a) {
      ...
      function po(o, a) {
        1 & o &&
          (t.TgZ(0, "mat-header-cell", 38), t._uU(1, "LABEL_PRICE"), t.qZA());
      }
      function mo(o, a) {
      ...
      function ho(o, a) {
        1 & o &&
          (t.TgZ(0, "mat-header-cell", 1), t._uU(1, "LABEL_QUANTITY"), t.qZA());
      }
      function _o(o, a) {
      ...
      let Kt = (() => {
          ...
          return (
            ...
            (o.ɵcmp = t.Xpm({
              ...
              template: function (e, n) {
                1 & e &&
                  (t.TgZ(0, "mat-card", 0)(1, "h1")(2, "span", 1),
                  ...
                  t.YNc(11, eo, 2, 0, "span", 6),
                  t.YNc(12, oo, 2, 0, "span", 6),
                  t.YNc(13, no, 2, 0, "span", 6),
                  t.YNc(14, ao, 2, 0, "span", 6),
                  t.YNc(15, io, 2, 0, "span", 6),
                  t.YNc(16, ro, 2, 0, "span", 6),
                  t.YNc(17, so, 6, 4, "span", 7),
                  t.YNc(18, lo, 6, 4, "span", 7),
                  t.qZA()()(),
                  ...
                  t.ynx(26, 13),
                  t.YNc(27, co, 2, 0, "mat-header-cell", 14),
                  t.YNc(28, uo, 2, 1, "mat-cell", 15),
                  t.BQk(),
                  t.ynx(29, 16),
                  t.YNc(30, po, 2, 0, "mat-header-cell", 17),
                  t.YNc(31, mo, 2, 1, "mat-cell", 18),
                  t.BQk(),
                  t.ynx(32, 19),
                  t.YNc(33, ho, 2, 0, "mat-header-cell", 14),
                  t.YNc(34, _o, 2, 1, "mat-cell", 20),
                  t.BQk(),
                  t.ynx(35, 21),
                  t.YNc(36, go, 2, 0, "mat-header-cell", 14),
                  t.YNc(37, fo, 2, 1, "mat-cell", 22),
                  t.BQk(),
                  t.YNc(38, Co, 1, 0, "mat-header-row", 23),
                  t.YNc(39, vo, 1, 0, "mat-row", 24),
                  t.qZA()(),
                  ...
                  2 & e &&
                    ...
                    t.xp6(2),
                    t.Q6J("translateParams", t.VKq(16, To, n.results.bonus)),
                    t.xp6(4),
                    t.Q6J(
                      "innerHtml",
                      t.lcZ(46, 14, "BONUS_FOR_FUTURE_PURCHASES"),
                      t.oJD
                    ));
              },
              dependencies: [
      ...
      function bo(o, a) {
        1 & o &&
          (t.TgZ(0, "mat-error", 2), t._uU(1, "MANDATORY_COMMENT "), t.qZA());
      }
      function xo(o, a) {
        1 & o &&
          (t.TgZ(0, "mat-error", 2), t._uU(1, "MANDATORY_CAPTCHA "), t.qZA());
      }
      function Ao(o, a) {
        1 & o &&
          (t.TgZ(0, "mat-error", 2), t._uU(1, "INVALID_CAPTCHA "), t.qZA());
      }
      const Zo = function () {
        return { length: "160" };
      };
        ...
        class o {
          constructor(e, n, i, r, l, u) {
            (this.userService = e),
              ...
              (this.authorControl = new s.p4({ value: "", disabled: !0 }, [])),
              (this.feedbackControl = new s.p4("", [
                s.kI.required,
                s.kI.maxLength(160),
              ])),
              (this.captchaControl = new s.p4("", [
                s.kI.required,
                s.kI.pattern("-?[\\d]*"),
              ])),
              ...
              (e) => {
                (this.feedback = {}),
                  ...
                  this.authorControl.setValue(
                    e.email ? `***${e.email.slice(3)}` : "anonymous"
                  );
              },
              (e) => {
            ...
            (this.feedback.captchaId = this.captchaId),
              ...
              this.feedbackService.save(this.feedback).subscribe(
                (e) => {
                  5 === e.rating
                    ? this.translate
                        .get("FEEDBACK_FIVE_STAR_THANK_YOU")
                        .subscribe(
                          (n) => {
          ...
          (o.ɵcmp = t.Xpm({
            ...
            consts: [
              ...
              [
                ...
                "text",
                "aria-label",
                "Field with the name of the author",
                3,
                "formControl",
              ],
              ...
              [
                ...
                "160",
                "aria-label",
                "Field for entering the comment or the feedback",
                3,
                "formControl",
                "placeholder",
              ],
              ...
              [
                ...
                "1",
                "aria-label",
                "Slider for selecting the star rating",
                3,
                "value",
                "displayWith",
                "valueChange",
              ...
              [
                ...
                "captcha",
                "aria-label",
                "CAPTCHA code which must be solved",
              ],
              [2, "font-size", "small"],
              [
                "id",
                ...
                "text",
                "aria-label",
                "Field for the result of the CAPTCHA code",
                "pattern",
                "-?[\\d]*",
                3,
                "formControl",
            ...
            template: function (e, n) {
              if (
                (1 & e &&
                  (t.TgZ(0, "div", 0)(1, "mat-card", 1)(2, "h1", 2),
                  ...
                  t._UZ(43, "input", 21),
                  t.ALo(44, "translate"),
                  t.YNc(45, xo, 2, 0, "mat-error", 12),
                  t.YNc(46, Ao, 2, 0, "mat-error", 12),
                  t.qZA()(),
                  t.TgZ(47, "button", 22),
                  t.NdJ("click", function () {
                    return n.save();
                ...
                t.xp6(5),
                  ...
                  t.xp6(7),
                  t.Oqu(t.xi3(17, 16, "MAX_TEXTAREA_LENGTH", t.DdM(25, Zo))),
                  t.xp6(2),
                  t.s9C(
                    "placeholder",
                    t.lcZ(20, 19, "WRITE_REVIEW_PLACEHOLDER")
                  ),
                  t.Q6J("formControl", n.feedbackControl),
                  t.xp6(4),
                  t.hij(
                    "",
                    (null == i.value ? null : i.value.length) || 0,
                    "/160"
                  ),
                  t.xp6(1),
                  t.Q6J(
                    "ngIf",
                    n.feedbackControl.invalid &&
                      n.feedbackControl.errors.required
                  ),
                  t.xp6(4),
                  ...
                  t.Q6J(
                    "ngIf",
                    n.captchaControl.invalid && n.captchaControl.errors.required
                  ),
                  t.xp6(1),
                  t.Q6J(
                    "ngIf",
                    n.captchaControl.invalid && n.captchaControl.errors.pattern
                  ),
                  t.xp6(1),
                  t.Q6J(
                    "disabled",
                    n.authorControl.invalid ||
                      n.feedbackControl.invalid ||
                      n.captchaControl.invalid ||
                      !n.rating
                  ),
                  t.xp6(3),
            ...
            styles: [
              "mat-card[_ngcontent-%COMP%]{height:auto;min-width:320px;width:30%}.form-container[_ngcontent-%COMP%]{display:flex;flex-direction:column;position:relative}.rating-container[_ngcontent-%COMP%]{margin-bottom:15px;margin-top:15px}.star[_ngcontent-%COMP%]{color:#c8c8c8}.active[_ngcontent-%COMP%], .select[_ngcontent-%COMP%]{color:gold}[_nghost-%COMP%]     .br{margin:0!important}#submitButton[_ngcontent-%COMP%]{margin-left:20%;margin-top:30px;width:60%}",
            ],
          })),
          o
        );
                  ...
                  .subscribe(
                    (e) => {
                      ...
                      null !== (n = null == e ? void 0 : e.application) &&
                        void 0 !== n &&
                        n.social &&
                        (e.application.social.twitterUrl &&
                          (this.twitterUrl = e.application.social.twitterUrl),
                        e.application.social.facebookUrl &&
                          (this.facebookUrl = e.application.social.facebookUrl),
                        e.application.social.slackUrl &&
                          (this.slackUrl = e.application.social.slackUrl),
                        e.application.social.redditUrl &&
                          (this.redditUrl = e.application.social.redditUrl),
                        e.application.social.pressKitUrl &&
                          (this.pressKitUrl =
                            e.application.social.pressKitUrl));
                    },
                    (e) => console.log(e)
              ...
              this.feedbackService.find().subscribe(
                (e) => {
                  for (let n = 0; n < e.length; n++)
                    (e[n].comment = `<span style="width: 90%; display:block;">${
                      e[n].comment
                    }<br/> (${this.stars[e[n].rating]})</span>`),
                      (e[n].comment = this.sanitizer.bypassSecurityTrustHtml(
                        e[n].comment
                      )),
            ...
            (o.ɵcmp = t.Xpm({
              ...
              consts: [
                ...
                [
                  ...
                  "margin-left: 0px;",
                  "aria-label",
                  "Button for the Twitter page of the shop",
                  3,
                  "href",
                  4,
                  "ngIf",
                ...
                [
                  ...
                  "noopener noreferrer",
                  "aria-label",
                  "Button for the Facebook page of the shop",
                  3,
                  "href",
                  4,
                  "ngIf",
                ...
                [
                  ...
                  "noopener noreferrer",
                  "aria-label",
                  "Button for the Slack page of the shop",
                  3,
                  "href",
                  4,
                  "ngIf",
                ...
                [
                  ...
                  "noopener noreferrer",
                  "aria-label",
                  "Button for the Reddit page of the shop",
                  3,
                  "href",
                  4,
                  "ngIf",
                ...
                [
                  ...
                  "noopener noreferrer",
                  "aria-label",
                  "Button for the PressKit page of the shop",
                  3,
                  "href",
                  4,
                  "ngIf",
              ...
              template: function (e, n) {
                1 & e &&
                  (t.TgZ(0, "div", 0)(1, "mat-card", 1)(2, "section", 2)(
                    3,
                    "h1",
                    3
                  ),
                  ...
                  t.YNc(16, Oo, 9, 5, "div", 7),
                  t.qZA()()()),
                  2 & e &&
                    (t.xp6(15),
                    t.Q6J("height", "300px")("autoPlay", !0)(
                      "arrowSize",
                      "10px"
                    )("showArrows", !0)("showDots", !1)(
                      "imageUrls",
                      n.slideshowDataSource
                    ),
                    t.xp6(1),
      ...
      function Lo(o, a) {
        1 & o &&
          (t.TgZ(0, "mat-error", 2), t._uU(1, "MANDATORY_EMAIL"), t.qZA());
      }
      function No(o, a) {
      ...
      function Eo(o, a) {
        1 & o &&
          (t.TgZ(0, "mat-error", 2), t._uU(1, "MANDATORY_PASSWORD "), t.qZA());
      }
      const oe = function () {
        return { length: "5-40" };
      };
      ...
      function Ro(o, a) {
        if (
          (1 & o &&
            (t._UZ(0, "mat-password-strength-info", 31),
            t.ALo(1, "translate"),
            t.ALo(2, "translate"),
            t.ALo(3, "translate"),
            t.ALo(4, "translate"),
          ...
          t.oxw();
          const e = t.MAs(41);
          t.Q6J("passwordComponent", e)(
            "lowerCaseCriteriaMsg",
            t.lcZ(1, 6, "LOWER_CASE_CRITERIA_MSG")
          )("upperCaseCriteriaMsg", t.lcZ(2, 8, "UPPER_CASE_CRITERIA_MSG"))(
            "digitsCriteriaMsg",
            t.lcZ(3, 10, "DIGITS_CRITERIA_MSG")
          )(
            "specialCharsCriteriaMsg",
            t.lcZ(4, 12, "SPECIAL_CHARS_CRITERIA_MSG")
          )(
            "minCharsCriteriaMsg",
            t.xi3(5, 14, "MIN_CHARS_CRITERIA_MSG", t.DdM(17, Fo))
          );
        }
      }
      function Yo(o, a) {
          ...
          save() {
            ...
            const n = {
              ...
              securityQuestion: this.securityQuestions.find(
                (i) => i.id === this.securityQuestionControl.value
              ),
              securityAnswer: this.securityAnswerControl.value,
            };
            this.userService.save(n).subscribe(
              (i) => {
              ...
              (i) => {
                ...
                if (
                  ...
                  this.error = l.message
                    ? l.message[0].toUpperCase() + l.message.slice(1)
                    : l;
                }
              }
            );
            ...
            template: function (e, n) {
              if (
                (1 & e &&
                  ...
                  t.qZA(),
                  t.YNc(11, Lo, 2, 0, "mat-error", 7),
                  t.YNc(12, No, 2, 0, "mat-error", 7),
                  t.qZA(),
                  ...
                  t._uU(24),
                  t.qZA(),
                  t.YNc(25, Eo, 2, 0, "mat-error", 7),
                  t.YNc(26, qo, 2, 2, "mat-error", 13),
                  t.qZA(),
                  ...
                  t._uU(33),
                  t.qZA(),
                  t.YNc(34, Mo, 2, 0, "mat-error", 7),
                  t.YNc(35, Do, 2, 0, "mat-error", 7),
                  t.qZA(),
                  ...
                  t.YNc(42, Ro, 6, 18, "mat-password-strength-info", 20),
                  t.TgZ(43, "div", 21)(44, "mat-form-field", 22)(
                    45,
                    "mat-label"
                  ),
                  t._uU(46),
                ...
                t.xp6(5),
                  ...
                  t.Q6J(
                    "ngIf",
                    n.emailControl.invalid && n.emailControl.errors.required
                  ),
                  t.xp6(1),
                  t.Q6J(
                    "ngIf",
                    n.emailControl.invalid && n.emailControl.errors.email
                  ),
                  t.xp6(4),
                  t.Q6J("formControl", n.passwordControl),
                  t.xp6(5),
                  t.Oqu(
                    t.xi3(22, 27, "INVALID_PASSWORD_LENGTH", t.DdM(38, oe))
                  ),
                  t.xp6(3),
                  t.hij(
                    "",
                  ...
                  t.Q6J(
                    "ngIf",
                    n.passwordControl.invalid &&
                      n.passwordControl.errors.required
                  ),
                  t.xp6(1),
                  t.Q6J(
                    "ngIf",
                    n.passwordControl.invalid &&
                      (n.passwordControl.errors.minlength ||
                        n.passwordControl.errors.maxlength)
                  ),
                  t.xp6(4),
                  ...
                  t.hij(
                    "",
                    (null == r.value ? null : r.value.length) || 0,
                    "/40"
                  ),
                  t.xp6(1),
                  t.Q6J(
                    "ngIf",
                    n.repeatPasswordControl.invalid &&
                      n.repeatPasswordControl.errors.required
                  ),
                  t.xp6(1),
                  t.Q6J(
                    "ngIf",
                    n.repeatPasswordControl.invalid &&
                      n.repeatPasswordControl.errors.notSame
                  ),
                  t.xp6(1),
                  t.Q6J("color", u.color),
                  t.xp6(2),
                  ...
                  t.Q6J(
                    "ngIf",
                    n.securityQuestionControl.invalid &&
                      n.securityQuestionControl.errors.required
                  ),
                  t.xp6(4),
                  t.Q6J("formControl", n.securityAnswerControl)(
                    "placeholder",
                    t.lcZ(59, 34, "SECURITY_ANSWER_PLACEHOLDER")
                  ),
                  t.xp6(2),
                  t.Q6J(
                    "ngIf",
                    n.securityAnswerControl.invalid &&
                      n.securityAnswerControl.errors.required
                  ),
                  t.xp6(1),
                  t.Q6J(
                    "disabled",
                    n.emailControl.invalid ||
                      n.passwordControl.invalid ||
                      n.repeatPasswordControl.invalid ||
                      n.securityQuestionControl.invalid ||
                      n.securityAnswerControl.invalid
      ...
      function Ho(o) {
        return function (e) {
          return o.value !== e.value ? { notSame: !0 } : null;
        };
      }
      var O = d(5245),
        F = d(7238);
      ...
      function tn(o, a) {
        if (
          (1 & o &&
            (t._UZ(0, "mat-password-strength-info", 29),
            t.ALo(1, "translate"),
            t.ALo(2, "translate"),
            t.ALo(3, "translate"),
            t.ALo(4, "translate"),
          ...
          t.Q6J("passwordComponent", e)(
            ...
            "minCharsCriteriaMsg",
            t.xi3(5, 14, "MIN_CHARS_CRITERIA_MSG", t.DdM(17, Xo))
          );
        }
      }
        ...
        class o {
          constructor(e, n, i) {
            (this.securityQuestionService = e),
              ...
              (this.passwordControl = new s.p4({ disabled: !0, value: "" }, [
                s.kI.required,
                s.kI.minLength(5),
              ])),
              (this.repeatPasswordControl = new s.p4(
                { disabled: !0, value: "" },
                [s.kI.required, on(this.passwordControl)]
              )),
                ...
                (this.securityQuestion = void 0),
                  this.emailControl.value
                    ? this.securityQuestionService
                        .findBy(this.emailControl.value)
                        .subscribe(
                          (e) => {
                            e
                              ? ((this.securityQuestion = e.question),
            ...
            this.userService
              ...
              .subscribe(
                () => {
                  (this.error = void 0),
                    this.translate
                      .get("PASSWORD_SUCCESSFULLY_CHANGED")
                      .subscribe(
                        (e) => {
                          this.confirmation = e;
                        },
          ...
          (o.ɵcmp = t.Xpm({
            ...
            consts: [
              ...
              [
                ...
                "right",
                "aria-label",
                "Please answer your selected security question",
                3,
                "matTooltip",
              ],
              [
            ...
            template: function (e, n) {
              if (
                (1 & e &&
                  ...
                  t._uU(7),
                  t.qZA(),
                  t.TgZ(8, "div", 5)(9, "mat-form-field", 6)(
                    10,
                    "mat-label",
                    2
                  ),
                  ...
                  t.qZA(),
                  t.YNc(16, Go, 2, 0, "mat-error", 9),
                  t.YNc(17, jo, 2, 0, "mat-error", 9),
                  t.qZA()(),
                  t.TgZ(18, "div", 10)(19, "mat-form-field", 6)(
                    20,
                    "mat-label",
                    2
                  ),
                  ...
                  t._uU(46),
                  t.qZA(),
                  t.YNc(47, Wo, 2, 0, "mat-error", 9),
                  t.YNc(48, $o, 2, 0, "mat-error", 9),
                  t.YNc(49, Vo, 2, 2, "mat-error", 20),
                  t.qZA(),
                  ...
                  t.YNc(56, tn, 6, 18, "mat-password-strength-info", 25),
                  t.qZA(),
                  t.TgZ(57, "button", 26),
                  t.NdJ("click", function () {
                ...
                t.xp6(4),
                  t.Q6J(
                    ...
                    !(
                      n.confirmation &&
                      !n.emailControl.dirty &&
                      !n.securityQuestionControl.dirty &&
                      !n.passwordControl.dirty &&
                      !n.repeatPasswordControl.dirty
                    )
                  ),
                  t.xp6(1),
                  ...
                  t.s9C(
                    "matTooltip",
                    t.lcZ(24, 29, "MANDATORY_SECURITY_ANSWER")
                  ),
                  t.xp6(3),
                  t.Q6J(
                    "ngIf",
                  ...
                  t.xp6(5),
                  t.Oqu(
                    t.xi3(36, 31, "INVALID_PASSWORD_LENGTH", t.DdM(38, ne))
                  ),
                  t.xp6(3),
                  t.hij(
                    "",
                  ...
                  t.Q6J(
                    "ngIf",
                    n.repeatPasswordControl.invalid &&
                      ((null == n.repeatPasswordControl
                        ? null
                        : n.repeatPasswordControl.errors.minlength) ||
                        (null == n.repeatPasswordControl
                          ? null
                          : n.repeatPasswordControl.errors.maxlength))
                  ),
                  t.xp6(1),
                  t.Q6J("color", u.color),
                  t.xp6(2),
                  ...
                  t.Q6J(
                    ...
                    n.emailControl.invalid ||
                      ...
                      n.passwordControl.invalid ||
                      n.repeatPasswordControl.invalid ||
                      n.repeatPasswordControl.disabled
                  ),
                  t.xp6(2),
            ...
            styles: [
              "mat-card[_ngcontent-%COMP%]{height:auto;min-width:320px;width:25%}mat-form-field[_ngcontent-%COMP%]{padding-top:10px}.form-container[_ngcontent-%COMP%]{display:flex;flex-direction:column;position:relative}button[_ngcontent-%COMP%]{display:block;margin-left:auto;margin-right:auto;margin-top:30px;width:60%}",
            ],
          })),
          o
        );
      ...
      function nn(o, a) {
        1 & o &&
          (t.TgZ(0, "mat-error", 1), t._uU(1, "MANDATORY_REVIEW"), t.qZA());
      }
        ...
        class o {
          constructor(e, n, i, r, l) {
            (this.data = e),
              ...
              (this.editReviewControl = new s.p4("", [
                s.kI.required,
                s.kI.minLength(1),
                s.kI.maxLength(160),
              ])),
          ...
          (o.ɵcmp = t.Xpm({
            ...
            consts: [
              ...
              [
                ...
                "4",
                "aria-label",
                "Text field to edit a product review",
                3,
                "formControl",
                "placeholder",
                "focus",
            ...
            template: function (e, n) {
              if (
                (1 & e &&
                  (t.TgZ(0, "mat-dialog-content")(1, "div", 0)(2, "h1", 1),
                  ...
                  t._uU(12),
                  t.qZA(),
                  t.YNc(13, nn, 2, 0, "mat-error", 6),
                  t.qZA()()()(),
                  t.TgZ(14, "mat-dialog-actions", 5)(15, "button", 7)(
                    16,
                    "i",
                    8
                  ),
                ...
                t.xp6(8),
                  t.s9C(
                    "placeholder",
                    t.lcZ(10, 7, "WRITE_REVIEW_PLACEHOLDER")
                  ),
      ...
      let ae = (() => {
          class o {
            ...
            ngOnInit() {
              (this.data.productData.points = Math.round(
            ...
            addReview(e) {
              const n = { message: e.value, author: this.author };
              (e.value = ""),
                this.productReviewService
                  .create(this.data.productData.id, n)
                  .subscribe(
                    () => {
                      this.reviews$ = this.productReviewService.get(
                        this.data.productData.id
          ...
          return (
            ...
            (o.ɵcmp = t.Xpm({
              ...
              consts: [
                ...
                [
                  "aria-label",
                  "Bonus points when buying the product",
                  3,
                  "matTooltip",
                  4,
                  "ngIf",
              ...
              template: function (e, n) {
                if (1 & e) {
                  const i = t.EpF();
                  t.TgZ(0, "mat-dialog-content")(1, "div", 0)(2, "div", 1)(
                    3,
                    "div",
                    2
                  ),
                    ...
                    t.TgZ(
                      ...
                      "mat-expansion-panel",
                      9
                    )(17, "mat-expansion-panel-header")(18, "mat-panel-title")(
                      19,
                      "span",
                      10
                    ),
                    ...
                    t.qZA()()(),
                    t._UZ(24, "button", 8),
                    t.YNc(25, ln, 3, 3, "div", 11),
                    t.ALo(26, "async"),
                    t.YNc(27, cn, 3, 0, "ng-template", null, 12, t.W1O),
                    t.qZA(),
                    t.TgZ(29, "div"),
                    ...
                    t._uU(45),
                    t.qZA()(),
                    t.TgZ(46, "mat-dialog-actions", 20)(47, "button", 21)(
                      48,
                      "i",
                      22
                    ),
                ...
                if (2 & e) {
                  ...
                  t.xp6(4),
                    ...
                    t.hij(
                      "(",
                      null == (l = t.lcZ(23, 22, n.reviews$)) ? null : l.length,
                      ")"
                    ),
                    t.xp6(3),
                    t.Q6J(
                      "ngIf",
                      (null == (u = t.lcZ(26, 24, n.reviews$))
                        ? null
                        : u.length) >= 1
                    )("ngIfElse", i),
                    t.xp6(6),
                    ...
                    t.Udp("display", n.isLoggedIn() ? "block" : "none"),
                    t.xp6(6),
                    t.Oqu(t.xi3(40, 26, "MAX_TEXTAREA_LENGTH", t.DdM(35, un))),
                    t.xp6(2),
                    t.s9C(
                      "placeholder",
                      t.lcZ(43, 29, "WRITE_REVIEW_PLACEHOLDER")
                    ),
      ...
      function pn(o, a) {
        1 & o && (t.TgZ(0, "div"), t._uU(1), t.ALo(2, "translate"), t.qZA()),
          2 & o && (t.xp6(1), t.Oqu(t.lcZ(2, 1, "TITLE_ALL_PRODUCTS")));
      }
      const mn = function (o) {
        return { quantity: o };
      };
      ...
      function fn(o, a) {
        if (
          (1 & o &&
            (t.TgZ(0, "span")(1, "s"), t._uU(2), t.qZA(), t._uU(3), t.qZA()),
          2 & o)
        ) {
          const e = t.oxw().$implicit;
      ...
      function vn(o, a) {
        if (1 & o) {
          ...
          t.TgZ(0, "mat-grid-tile")(1, "mat-card", 13),
            t.YNc(2, hn, 3, 3, "div", 14),
            t.YNc(3, _n, 3, 0, "div", 15),
            t.TgZ(4, "div", 16),
            t.NdJ("click", function () {
              const r = t.CHM(e).$implicit,
                l = t.oxw(2);
            ...
            t.qZA(),
            t.TgZ(10, "div", 21),
            t.YNc(11, gn, 2, 1, "span", 3),
            t.YNc(12, fn, 4, 2, "span", 3),
            t.qZA()()(),
            t.TgZ(13, "div", 22),
            t.YNc(14, Cn, 3, 0, "button", 23),
            t.qZA()()();
        }
        if (2 & o) {
          const e = a.$implicit,
      ...
      function Tn(o, a) {
        if (1 & o) {
          ...
          t.TgZ(0, "div")(1, "mat-grid-list", 10, 11),
            ...
            t.YNc(3, vn, 15, 10, "mat-grid-tile", 12),
            t.ALo(4, "async"),
            t.qZA()();
        }
        if (2 & o) {
      ...
      let yt = (() => {
          class o {
              ...
              (0, Zt.D)([n, e]).subscribe(
                ([i, r]) => {
                  ...
                  u &&
                    ...
                    this.startHackingInstructor(decodeURIComponent(u)),
                      ...
                      ? ((this.breakpoint = 4),
                        window.innerWidth < 1740 &&
                          ...
                          window.innerWidth < 1280 &&
                            ((this.breakpoint = 2),
                            window.innerWidth < 850 && (this.breakpoint = 1))))
                      : (this.breakpoint = 6),
            ...
            trustProductDescription(e) {
              for (let n = 0; n < e.length; n++)
                e[n].description = this.sanitizer.bypassSecurityTrustHtml(
                  e[n].description
                );
            }
            ngOnDestroy() {
            ...
            addToBasket(e) {
              this.basketService
                .find(Number(sessionStorage.getItem("bid")))
                .subscribe(
                  (n) => {
                    const i = n.Products;
                    let r = !1;
                    for (let l = 0; l < i.length; l++)
                      if (i[l].id === e) {
                        (r = !0),
                          this.basketService.get(i[l].BasketItem.id).subscribe(
                            (u) => {
                              this.basketService
                                .put(u.id, { quantity: u.quantity + 1 })
                                .subscribe(
                                  (b) => {
                                    this.productService
                                      .get(b.ProductId)
                    ...
                    r ||
                      this.basketService
                        ...
                        .subscribe(
                          (l) => {
                            this.productService.get(l.ProductId).subscribe(
                              (u) => {
                                this.translateService
                                  .get("BASKET_ADD_PRODUCT", {
                                    product: u.name,
                                  })
                                  .subscribe(
                                    (f) => {
            ...
            onResize(e) {
              e.target.innerWidth < 2600
                ? ((this.breakpoint = 4),
                  e.target.innerWidth < 1740 &&
                    ((this.breakpoint = 3),
                    e.target.innerWidth < 1280 &&
                      ((this.breakpoint = 2),
                      e.target.innerWidth < 850 && (this.breakpoint = 1))))
                : (this.breakpoint = 6);
            }
            isDeluxe() {
              return this.deluxeGuard.isDeluxe();
              ...
              template: function (e, n) {
                if (
                  (1 & e &&
                    ...
                    t.YNc(3, dn, 5, 4, "div", 3),
                    t.YNc(4, pn, 3, 3, "div", 3),
                    t._UZ(5, "div", 4),
                    t.qZA(),
                    t.YNc(6, Tn, 5, 4, "div", 5),
                    t.YNc(7, bn, 8, 0, "ng-template", null, 6, t.W1O),
                  ...
                  t.xp6(3),
                    ...
                    t.xp6(4),
                    t.Q6J("pageSize", 12)("pageSizeOptions", n.pageSizeOptions)(
                      "length",
                      n.resultsLength
                    );
                }
      ...
      function Zn(o, a) {
        1 & o &&
          (t.TgZ(0, "mat-error", 5), t._uU(1, "MANDATORY_EMAIL"), t.qZA());
      }
      function wn(o, a) {
        if (1 & o) {
          const e = t.EpF();
      ...
      function yn(o, a) {
        1 & o &&
          (t.TgZ(0, "mat-error", 5), t._uU(1, "MANDATORY_PASSWORD"), t.qZA());
      }
      function In(o, a) {
        1 & o &&
          (t.TgZ(0, "div", 25)(1, "div", 26),
          t._UZ(2, "div"),
          t.qZA(),
          t.TgZ(3, "div", 27),
          t._uU(4, "LABEL_OR"),
        ...
        class o {
          ...
          ngOnInit() {
            ...
            e
              ? ((this.user = {}),
                (this.user.email = e),
                this.rememberMe.setValue(!0))
              : this.rememberMe.setValue(!1),
              (this.redirectUri = `${this.windowRefService.nativeWindow.location.protocol}//${this.windowRefService.nativeWindow.location.host}`),
              this.configurationService.getApplicationConfiguration().subscribe(
                (n) => {
                  var i;
                  if (
                    null !== (i = null == n ? void 0 : n.application) &&
                    void 0 !== i &&
                    i.googleOauth
                  ) {
                    this.clientId = n.application.googleOauth.clientId;
                    const r =
                      n.application.googleOauth.authorizedRedirects.find(
                        (l) => l.uri === this.redirectUri
                      );
                    r
                      ? ((this.oauthUnavailable = !1),
                        (this.redirectUri = r.proxy ? r.proxy : r.uri))
                      : ((this.oauthUnavailable = !0),
                        console.log(
                          this.redirectUri +
              ...
              this.userService.login(this.user).subscribe(
                (n) => {
                  ...
                  i.setHours(i.getHours() + 8),
                    this.cookieService.put("token", n.token, { expires: i }),
                ...
                ({ error: n }) => {
                  if (n.status && n.data && "totp_token_required" === n.status)
                    return (
                      localStorage.setItem("totp_tmp_token", n.data.tmpToken),
          ...
          (o.ɵcmp = t.Xpm({
            ...
            consts: [
              ...
              [
                ...
                "",
                "aria-label",
                "Text field for the login email",
                3,
                "formControl",
                "focus",
              ],
              ...
              [
                ...
                "rememberMe",
                "aria-label",
                "Checkbox to stay logged in or not logged in",
                3,
                "formControl",
              ],
            ...
            template: function (e, n) {
              1 & e &&
                (t.TgZ(0, "div", 0)(1, "mat-card", 1)(2, "h1"),
                t._uU(3, "Login"),
                t.qZA(),
                t.YNc(4, An, 2, 1, "div", 2),
                ...
                t.qZA(),
                t.YNc(17, wn, 3, 3, "button", 11),
                t.YNc(18, Sn, 3, 3, "button", 12),
                t.YNc(19, yn, 2, 0, "mat-error", 8),
                t.qZA(),
                t.TgZ(20, "a", 13),
                ...
                t.ALo(29, "translate"),
                t.qZA(),
                t.YNc(30, In, 7, 0, "div", 16),
                t.YNc(31, Un, 4, 3, "button", 17),
                ...
                2 & e &&
                  ...
                  t.Q6J(
                    "disabled",
                    !n.emailControl.value || !n.passwordControl.value
                  ),
                  t.xp6(3),
      ...
      let Pn = (() => {
          ...
          return (
            ...
            (o.ɵcmp = t.Xpm({
              ...
              template: function (e, n) {
                1 & e &&
                  (t.TgZ(0, "mat-dialog-content", 0)(1, "header")(2, "h1"),
                  t._uU(3),
                  t.ALo(4, "translate"),
                  t.qZA()(),
                  t._UZ(5, "mat-divider"),
                  ...
                  2 & e &&
                    ...
                    t.AsE(
                      "",
                      t.lcZ(4, 6, "LABEL_USER"),
                      " #",
                      null == n.user ? null : n.user.id,
                      ""
                    ),
                    t.xp6(8),
              ...
              styles: [
                "mat-divider[_ngcontent-%COMP%]{margin-bottom:10px}.dialogAction[_ngcontent-%COMP%]{margin-bottom:0!important}",
              ],
            })),
            o
          );
        ...
        Ln = (() => {
          ...
          return (
            ...
            (o.ɵcmp = t.Xpm({
              ...
              styles: [
                "mat-divider[_ngcontent-%COMP%]{margin-bottom:10px}.dialogAction[_ngcontent-%COMP%]{margin-bottom:0!important}mat-dialog-content[_ngcontent-%COMP%]{max-width:320px;min-width:280px}",
              ],
            })),
            o
          );
      ...
      function Dn(o, a) {
        if (
          (1 & o &&
            (t.TgZ(0, "mat-cell", 28), t.YNc(1, Mn, 1, 0, "i", 29), t.qZA()),
          2 & o)
        ) {
          const e = a.$implicit;
      ...
      function ia(o, a) {
        if (
          (1 & o &&
            (t.TgZ(0, "mat-cell"), t.YNc(1, aa, 2, 0, "mat-icon", 36), t.qZA()),
          2 & o)
        ) {
          const e = a.$implicit,
            n = t.oxw();
      ...
      let ua = (() => {
        class o {
            ...
            this.userService.find().subscribe(
              (e) => {
                ...
                for (const n of this.userDataSource)
                  n.email = this.sanitizer.bypassSecurityTrustHtml(
                    `<span class="${n.token ? "confirmation" : "error"}">${
                      n.email
                    }</span>`
                  );
          ...
          showUserDetail(e) {
            this.dialog.open(Pn, { data: { id: e } });
          }
          showFeedbackDetails(e, n) {
            this.dialog.open(Ln, { data: { feedback: e, id: n } });
          }
          times(e) {
            return Array(e).fill("\u2605");
          }
        ...
        return (
          ...
          (o.ɵcmp = t.Xpm({
            ...
            template: function (e, n) {
              1 & e &&
                (t.TgZ(0, "mat-card", 0)(1, "h1", 1),
                t._uU(2, "TITLE_ADMINISTRATION"),
                t.qZA(),
                t.TgZ(3, "div", 2)(4, "div", 3)(5, "div", 4)(6, "div", 5)(
                  7,
                  "span",
                  1
                ),
                ...
                t.TgZ(9, "mat-table", 6),
                t.ynx(10, 7),
                t.YNc(11, qn, 1, 0, "mat-header-cell", 8),
                t.YNc(12, Dn, 2, 1, "mat-cell", 9),
                t.BQk(),
                t.ynx(13, 10),
                t.YNc(14, Fn, 1, 0, "mat-header-cell", 11),
                t.YNc(15, Rn, 1, 1, "mat-cell", 12),
                t.BQk(),
                t.ynx(16, 13),
                t.YNc(17, Yn, 1, 0, "mat-header-cell", 8),
                t.YNc(18, Bn, 3, 0, "mat-cell", 14),
                t.BQk(),
                t.YNc(19, Jn, 1, 0, "mat-header-row", 15),
                t.YNc(20, Qn, 1, 0, "mat-row", 16),
                t.qZA(),
                t._UZ(21, "mat-paginator", 17, 18),
                t.qZA(),
                t.TgZ(23, "mat-table", 19),
                t.ynx(24, 7),
                t.YNc(25, Hn, 1, 0, "mat-header-cell", 8),
                t.YNc(26, Gn, 1, 0, "mat-cell", 9),
                t.BQk(),
                t.ynx(27, 10),
                t.YNc(28, jn, 1, 0, "mat-header-cell", 11),
                t.YNc(29, zn, 1, 1, "mat-cell", 12),
                t.BQk(),
                t.ynx(30, 13),
                t.YNc(31, Kn, 1, 0, "mat-header-cell", 8),
                t.YNc(32, Wn, 3, 0, "mat-cell", 14),
                t.BQk(),
                t.YNc(33, $n, 1, 0, "mat-header-row", 15),
                t.YNc(34, Vn, 1, 0, "mat-row", 16),
                t.qZA()(),
                t.TgZ(35, "div", 20)(36, "div", 21)(37, "div", 5)(
                  38,
                  "span",
                  1
                ),
                ...
                t.ynx(41, 7),
                t.YNc(42, Xn, 1, 0, "mat-header-cell", 11),
                t.YNc(43, ta, 2, 1, "mat-cell", 14),
                t.BQk(),
                t.ynx(44, 22),
                t.YNc(45, ea, 1, 0, "mat-header-cell", 11),
                t.YNc(46, oa, 2, 1, "mat-cell", 23),
                t.BQk(),
                t.ynx(47, 24),
                t.YNc(48, na, 1, 0, "mat-header-cell", 11),
                t.YNc(49, ia, 2, 1, "mat-cell", 14),
                t.BQk(),
                t.ynx(50, 25),
                t.YNc(51, ra, 1, 0, "mat-header-cell", 8),
                t.YNc(52, sa, 3, 0, "mat-cell", 14),
                t.BQk(),
                t.YNc(53, la, 1, 0, "mat-header-row", 15),
                t.YNc(54, ca, 1, 0, "mat-row", 16),
                t.qZA(),
        ...
        class o {
          constructor(e, n, i) {
            (this.userService = e),
              ...
              (this.translate = i),
              (this.passwordControl = new s.p4("", [s.kI.required])),
              (this.newPasswordControl = new s.p4("", [
                s.kI.required,
                s.kI.minLength(5),
                s.kI.maxLength(40),
              ])),
              (this.repeatNewPasswordControl = new s.p4("", [
                s.kI.required,
                s.kI.minLength(5),
                s.kI.maxLength(40),
                fa(this.newPasswordControl),
              ]));
          }
          ngOnInit() {
            this.formSubmitService.attachEnterKeyHandler(
          ...
          changePassword() {
            var e;
            (null === (e = localStorage.getItem("email")) || void 0 === e
              ? void 0
              : e.match(/support@.*/)) &&
              ...
              console.error(
                "Parola echipei de asisten\u021b\u0103 nu respect\u0103 politica corporativ\u0103 pentru conturile privilegiate! V\u0103 rug\u0103m s\u0103 schimba\u021bi parola \xeen consecin\u021b\u0103!"
              ),
              this.userService
                .changePassword({
          ...
          (o.ɵcmp = t.Xpm({
            ...
            consts: [
              ...
              [
                ...
                "",
                "aria-label",
                "Field to repeat the new password",
                3,
                "formControl",
              ],
              ["passwordRepeat", ""],
            ...
            template: function (e, n) {
              if (
                (1 & e &&
                  ...
                  t._uU(26),
                  t.qZA(),
                  t.YNc(27, pa, 2, 0, "mat-error", 8),
                  t.YNc(28, ma, 2, 2, "mat-error", 14),
                  t.qZA(),
                  ...
                  t._uU(35),
                  t.qZA(),
                  t.YNc(36, ha, 2, 0, "mat-error", 8),
                  t.YNc(37, _a, 2, 0, "mat-error", 8),
                  t.qZA()(),
                  t.TgZ(38, "button", 17),
                  t.NdJ("click", function () {
                ...
                t.xp6(4),
                  t.Q6J(
                    ...
                    !(
                      n.confirmation &&
                      !n.passwordControl.dirty &&
                      !n.newPasswordControl.dirty &&
                      !n.repeatNewPasswordControl.dirty
                    )
                  ),
                  t.xp6(1),
                  t.hij(" ", n.confirmation, " "),
                  ...
                  t.s9C(
                    "placeholder",
                    t.lcZ(13, 18, "MANDATORY_CURRENT_PASSWORD")
                  ),
                  t.Q6J("formControl", n.passwordControl),
                  t.xp6(2),
                  t.Q6J("ngIf", n.passwordControl.invalid),
                  ...
                  t.xp6(5),
                  t.Oqu(
                    t.xi3(24, 20, "INVALID_PASSWORD_LENGTH", t.DdM(25, re))
                  ),
                  t.xp6(3),
                  t.hij(
                    "",
                  ...
                  t.Q6J(
                    "ngIf",
                    (null == n.newPasswordControl
                      ? null
                      : n.newPasswordControl.invalid) &&
                      (null == n.newPasswordControl
                        ? null
                        : n.newPasswordControl.errors.required)
                  ),
                  t.xp6(1),
                  t.Q6J(
                    "ngIf",
                    (null == n.newPasswordControl
                      ...
                      ((null == n.newPasswordControl
                        ? null
                        : n.newPasswordControl.errors.minlength) ||
                        (null == n.newPasswordControl
                          ? null
                          : n.newPasswordControl.errors.maxlength))
                  ),
                  t.xp6(4),
                  ...
                  t.Q6J(
                    "ngIf",
                    n.repeatNewPasswordControl.invalid &&
                      n.repeatNewPasswordControl.errors.required
                  ),
                  t.xp6(1),
                  t.Q6J(
                    "ngIf",
                    n.repeatNewPasswordControl.invalid &&
                      n.repeatNewPasswordControl.errors.notSame
                  ),
                  t.xp6(1),
                  t.Q6J(
                    "disabled",
            ...
            styles: [
              "mat-card[_ngcontent-%COMP%]{height:auto;min-width:320px;width:25%}mat-form-field[_ngcontent-%COMP%]{padding-top:10px}.form-container[_ngcontent-%COMP%]{display:flex;flex-direction:column;position:relative}button[_ngcontent-%COMP%]{margin-top:5px}#changeButton[_ngcontent-%COMP%]{margin-left:20%;margin-top:30px;width:60%}",
            ],
          })),
          o
        );
      ...
      function Ta(o, a) {
        1 & o &&
          (t.TgZ(0, "div", 20), t._uU(1), t.ALo(2, "translate"), t.qZA()),
          2 & o &&
            (t.xp6(1),
            t.hij("", t.xi3(2, 1, "INVALID_FILE_TYPE", t.DdM(4, va)), " "));
      }
      const ba = function () {
        return { size: "100 KB" };
      };
      function xa(o, a) {
        1 & o &&
          ...
          2 & o &&
            (t.xp6(1),
            t.hij("", t.xi3(2, 1, "INVALID_FILE_SIZE", t.DdM(4, ba)), " "));
      }
      function Aa(o, a) {
        1 & o &&
          (t.TgZ(0, "mat-error"), t._uU(1), t.ALo(2, "translate"), t.qZA()),
          2 & o && (t.xp6(1), t.hij("", t.lcZ(2, 1, "MANDATORY_MESSAGE"), " "));
      }
      const Za = function () {
        return { length: "160" };
      };
            ...
            saveComplaint() {
              (this.complaint.message = this.messageControl.value),
                this.complaintService.save(this.complaint).subscribe(
                  (e) => {
                    this.translate
                      .get("CUSTOMER_SUPPORT_COMPLAINT_REPLY", { ref: e.id })
                      .subscribe(
                        (n) => {
                          this.confirmation = n;
                        },
            ...
            (o.ɵcmp = t.Xpm({
              ...
              consts: [
                ...
                [
                  ...
                  "",
                  "aria-label",
                  "Text field for the mail address of the user",
                  3,
                  "formControl",
                ],
                [1, "fas", "fa-exclamation-circle"],
                ...
                [
                  ...
                  "",
                  "aria-label",
                  "Field for entering the complaint",
                  3,
                  "formControl",
                  "placeholder",
                ],
              ...
              template: function (e, n) {
                if (
                  (1 & e &&
                    ...
                    t._uU(5),
                    t.qZA(),
                    t.YNc(6, Ta, 3, 5, "div", 4),
                    t.YNc(7, xa, 3, 5, "div", 4),
                    t.TgZ(8, "div", 5)(9, "mat-form-field", 6)(
                      10,
                      "mat-label",
                      2
                  ...
                  t.xp6(4),
                    t.Q6J(
                      "hidden",
                      !(n.confirmation && !n.messageControl.dirty)
                    ),
                    t.xp6(1),
                    ...
                    t.Q6J(
                      "ngIf",
                      n.fileUploadError && "mimeType" == n.fileUploadError.name
                    ),
                    t.xp6(1),
                    t.Q6J(
                      "ngIf",
                      n.fileUploadError && "fileSize" == n.fileUploadError.name
                    ),
                    t.xp6(5),
                    t.Q6J("formControl", n.customerControl),
                    t.xp6(7),
                    t.Oqu(t.xi3(20, 13, "MAX_TEXTAREA_LENGTH", t.DdM(20, Za))),
                    t.xp6(2),
                    t.s9C(
                      "placeholder",
                      t.lcZ(23, 16, "WRITE_MESSAGE_PLACEHOLDER")
                    ),
                    t.Q6J("formControl", n.messageControl),
                    t.xp6(3),
                    t.Q6J(
                      "ngIf",
                      n.messageControl.invalid &&
                        (null == n.messageControl
                          ? null
                          : n.messageControl.errors.required)
                    ),
                    t.xp6(2),
                    t.hij(
                      "",
                    ...
                    t.Q6J(
                      "disabled",
                      n.messageControl.invalid || n.fileUploadError
                    ),
                    t.xp6(3),
              ...
              styles: [
                "mat-card[_ngcontent-%COMP%]{height:auto;min-width:320px;width:30%}mat-form-field[_ngcontent-%COMP%]{padding-top:10px}.form-container[_ngcontent-%COMP%]{display:flex;flex-direction:column;position:relative}#submitButton[_ngcontent-%COMP%]{margin-left:20%;margin-top:30px;width:60%}",
              ],
            })),
            o
          );
      ...
      function Ia(o, a) {
        if (
          (1 & o &&
            (t.TgZ(0, "div", 13),
            t.YNc(1, Sa, 1, 1, "img", 14),
            t.YNc(2, ya, 1, 1, "img", 15),
            t.TgZ(3, "div"),
            t._uU(4),
            t.qZA()()),
          2 & o)
          ...
          t.xp6(1),
            ...
            t.xp6(1),
            t.Tol(
              "user" == e.author ? "speech-bubble-right" : "speech-bubble-left"
            ),
            t.xp6(1),
            t.hij(" ", e.body, " ");
        }
          ...
          class o {
            ...
            ngOnInit() {
              this.chatbotService.getChatbotStatus().subscribe((e) => {
                this.messages.push({ author: V.bot, body: e.body }),
                  e.action &&
            ...
            handleResponse(e) {
              if (
                ...
                n.setHours(n.getHours() + 8),
                  this.cookieService.put("token", e.token, { expires: n });
              }
            }
            sendMessage() {
              const e = this.messageControl.value;
              e &&
                (this.messages.push({ author: V.user, body: e }),
                this.messageControl.setValue(""),
                this.chatbotService.getChatbotStatus().subscribe((n) => {
                  n.status || n.action
                    ? this.chatbotService
                        .getResponse(this.currentAction, e)
                        .subscribe((r) => {
                          this.handleResponse(r);
                        })
                    : this.messages.push({ author: V.bot, body: n.body });
            ...
            (o.ɵcmp = t.Xpm({
              ...
              template: function (e, n) {
                1 & e &&
                  ...
                  t.YNc(11, Ia, 5, 6, "div", 6),
                  t.qZA(),
                  t.TgZ(12, "div", 7)(13, "div", 8)(14, "mat-form-field", 9)(
                    15,
                    "mat-label",
                    10
                  ),
                  ...
                  2 & e &&
                    ...
                    t.hij(
                      "(",
                      t.xi3(7, 7, "LABEL_POWERED_BY_CHATBOT", t.DdM(12, Ua)),
                      ")"
                    ),
                    t.xp6(5),
                    ...
                    t.s9C(
                      "placeholder",
                      t.lcZ(19, 10, "ASK_ME_ANYTHING_PLACEHOLDER")
                    ),
                    t.Q6J("formControl", n.messageControl));
              },
              dependencies: [
      ...
      function Da(o, a) {
        if ((1 & o && (t.TgZ(0, "mat-cell", 23), t._uU(1), t.qZA()), 2 & o)) {
          ...
          t.xp6(1),
            t.HOy(
              " ",
              null == e ? null : e.streetAddress,
              ", ",
              null == e ? null : e.city,
              ", ",
              null == e ? null : e.state,
              ", ",
              null == e ? null : e.zipCode,
              " "
            );
        }
      }
      ...
      function Ba(o, a) {
        if (
          (1 & o &&
            (t.TgZ(0, "mat-cell", 24)(1, "button", 25),
            t._UZ(2, "i", 26),
            t.qZA()()),
          2 & o)
        ) {
          ...
          t.TgZ(0, "mat-row", 29),
            t.NdJ("click", function () {
              const i = t.CHM(e),
                ...
                u = t.oxw(2);
              return (
                u.selection.toggle(r), t.KtG(u.emitSelectionToParent(l.id))
              );
            }),
            t.qZA();
        }
      ...
      function ja(o, a) {
        if (
          (1 & o &&
            (t.TgZ(0, "mat-table", 6),
            t.ynx(1, 7),
            t.YNc(2, La, 1, 0, "mat-header-cell", 8),
            t.YNc(3, Na, 2, 1, "mat-cell", 9),
            t.BQk(),
            t.ynx(4, 10),
            t.YNc(5, Ea, 1, 0, "mat-header-cell", 11),
            t.YNc(6, qa, 2, 1, "mat-cell", 9),
            t.BQk(),
            t.ynx(7, 12),
            t.YNc(8, Ma, 1, 0, "mat-header-cell", 11),
            t.YNc(9, Da, 2, 4, "mat-cell", 13),
            t.BQk(),
            t.ynx(10, 14),
            t.YNc(11, Fa, 1, 0, "mat-header-cell", 11),
            t.YNc(12, Ra, 2, 1, "mat-cell", 9),
            t.BQk(),
            t.ynx(13, 15),
            t.YNc(14, Ya, 1, 0, "mat-header-cell", 11),
            t.YNc(15, Ba, 3, 1, "mat-cell", 16),
            t.BQk(),
            t.ynx(16, 17),
            t.YNc(17, Ja, 1, 0, "mat-header-cell", 11),
            t.YNc(18, Qa, 3, 0, "mat-cell", 16),
            t.BQk(),
            t.YNc(19, Ha, 1, 0, "mat-header-row", 18),
            t.YNc(20, Ga, 1, 0, "mat-row", 19),
            t.qZA()),
          2 & o)
        ) {
          const e = t.oxw();
      ...
      function za(o, a) {
        1 & o &&
          (t.TgZ(0, "div", 30)(1, "button", 31)(2, "mat-icon"),
          t._uU(3, " add "),
          t.qZA(),
          t.TgZ(4, "span", 5),
        ...
        class o {
          ...
          load() {
            this.addressService.get().subscribe(
              ...
              (e) => {
                var n;
                this.snackBarHelperService.open(
                  null === (n = e.error) || void 0 === n ? void 0 : n.error,
                  "errorBar"
                ),
                  console.log(e);
              }
          ...
          emitSelectionToParent(e) {
            this.selection.hasValue()
              ? (this.emitSelection.emit(e), (this.addressId = e))
              : (this.emitSelection.emit(void 0), (this.addressId = void 0));
          }
          chooseAddress() {
            var e = this;
          ...
          deleteAddress(e) {
            this.addressService.del(e).subscribe(
              ...
              (n) => {
                var i;
                this.snackBarHelperService.open(
                  null === (i = n.error) || void 0 === i ? void 0 : i.error,
                  "errorBar"
                ),
                  console.log(n);
              }
          ...
          (o.ɵcmp = t.Xpm({
            ...
            template: function (e, n) {
              1 & e &&
                ...
                t.YNc(1, Oa, 2, 0, "h1", 1),
                t.YNc(2, Pa, 2, 0, "h1", 1),
                t.YNc(3, ja, 21, 3, "mat-table", 2),
                t.YNc(4, za, 6, 0, "div", 3),
                t.YNc(5, Ka, 5, 1, "button", 4),
                t.qZA()),
                2 & e &&
                  (t.ekj("div-boundary", !n.addNewAddressDiv),
                  t.xp6(1),
            ...
            styles: [
              ".btn-new-address[_ngcontent-%COMP%]{display:block;margin-left:0;margin-right:auto}.btn-next[_ngcontent-%COMP%]{display:block;margin-left:auto;margin-right:0;margin-top:-37px}mat-header-row[_ngcontent-%COMP%]{min-height:0!important}.heading[_ngcontent-%COMP%]{background:rgba(0,0,0,.2);font-size:x-large}.heading-text[_ngcontent-%COMP%]{justify-content:center;padding:12px 20px}.div-boundary[_ngcontent-%COMP%]{border:1px solid rgba(255,255,255,.3);border-radius:5px;box-shadow:0 0!important}",
            ],
          })),
          o
        );
      ...
      function $a(o, a) {
        1 & o &&
          (t.TgZ(0, "mat-error", 2), t._uU(1, " MANDATORY_QUANTITY "), t.qZA());
      }
      const Va = function () {
      ...
      function Xa(o, a) {
        1 & o &&
          (t.TgZ(0, "mat-error", 21), t._uU(1, "INVALID_QUANTITY "), t.qZA()),
          2 & o && t.Q6J("translateParams", t.DdM(1, Va));
      }
      function ti(o, a) {
      ...
      function ei(o, a) {
        if (
          (1 & o &&
            (t.TgZ(0, "mat-form-field", 22)(1, "mat-label", 2),
            t._uU(2, "LABEL_PICKUP_DATE"),
            t.qZA(),
            t._UZ(3, "input", 23)(4, "mat-datepicker-toggle", 24)(
              5,
              "mat-datepicker",
              null,
              25
            ),
            t.YNc(7, ti, 2, 0, "mat-error", 7),
            t.qZA()),
          2 & o)
        ) {
          const e = t.MAs(6),
      ...
      let ni = (() => {
          class o {
            constructor(e, n, i, r, l, u) {
              (this.recycleService = e),
                ...
                (this.recycleQuantityControl = new s.p4("", [
                  s.kI.required,
                  s.kI.min(10),
                  s.kI.max(1e3),
                ])),
              ...
              this.configurationService.getApplicationConfiguration().subscribe(
                (e) => {
                  ...
                  null !== (n = null == e ? void 0 : e.application) &&
                    void 0 !== n &&
                    n.recyclePage &&
                    ((this.topImage = `assets/public/images/products/${e.application.recyclePage.topProductImage}`),
          ...
          return (
            ...
            (o.ɵcmp = t.Xpm({
              ...
              template: function (e, n) {
                1 & e &&
                  (t.TgZ(0, "mat-card", 0)(1, "div", 1)(2, "h1", 2),
                  ...
                  t._UZ(12, "input", 6),
                  t.ALo(13, "translate"),
                  t.YNc(14, $a, 2, 0, "mat-error", 7),
                  t.YNc(15, Xa, 2, 2, "mat-error", 8),
                  t.qZA(),
                  ...
                  t.qZA(),
                  t.YNc(18, ei, 8, 4, "mat-form-field", 11),
                  t.YNc(19, oi, 3, 4, "mat-checkbox", 12),
                  t.qZA(),
                  t.TgZ(20, "button", 13),
                  t.NdJ("click", function () {
                    return n.save();
                  ...
                  2 & e &&
                    ...
                    t.xp6(4),
                    t.Q6J("formControl", n.recycleQuantityControl)(
                      "placeholder",
                      t.lcZ(13, 12, "IN_LITERS_PLACEHOLDER")
                    ),
                    t.xp6(2),
                    t.Q6J(
                      "ngIf",
                      n.recycleQuantityControl.invalid &&
                        n.recycleQuantityControl.errors.required
                    ),
                    t.xp6(1),
                    t.Q6J(
                      "ngIf",
                      n.recycleQuantityControl.invalid &&
                        (n.recycleQuantityControl.errors.min ||
                          n.recycleQuantityControl.errors.max)
                    ),
                    t.xp6(1),
                    ...
                    t.Q6J(
                      "ngIf",
                      n.pickup.value && n.recycleQuantityControl.value > 100
                    ),
                    t.xp6(1),
      ...
      let ri = (() => {
          class o {
            ...
            save(e = "owasp_juice_shop") {
              const n = { version: this.VERSION };
              (n.scoreBoard = {
                displayedDifficulties: localStorage.getItem(
                  "displayedDifficulties"
                )
                  ? JSON.parse(
                      String(localStorage.getItem("displayedDifficulties"))
                    )
                  : void 0,
                showSolvedChallenges: localStorage.getItem(
                  "showSolvedChallenges"
                )
                  ? JSON.parse(
                      String(localStorage.getItem("showSolvedChallenges"))
                    )
                  : void 0,
                showDisabledChallenges: localStorage.getItem(
                  "showDisabledChallenges"
                )
                  ? JSON.parse(
                      String(localStorage.getItem("showDisabledChallenges"))
                    )
                  : void 0,
                showOnlyTutorialChallenges: localStorage.getItem(
                  ...
                  : void 0,
                displayedChallengeCategories: localStorage.getItem(
                ...
                (n.banners = {
                  welcomeBannerStatus: this.cookieService.get(
                    "welcomebanner_status"
                  )
                    ? this.cookieService.get("welcomebanner_status")
                    : void 0,
                  cookieConsentStatus: this.cookieService.get(
                    "cookieconsent_status"
                  )
                    ? this.cookieService.get("cookieconsent_status")
                    : void 0,
                }),
                (n.language = this.cookieService.get("language")
                  ? this.cookieService.get("language")
                  : void 0),
                (n.continueCode = this.cookieService.get("continueCode")
                  ? this.cookieService.get("continueCode")
                  : void 0),
                (n.continueCodeFindIt = this.cookieService.get(
                  "continueCodeFindIt"
                )
                  ? this.cookieService.get("continueCodeFindIt")
                  : void 0),
                (n.continueCodeFixIt = this.cookieService.get(
                  "continueCodeFixIt"
                )
                  ? this.cookieService.get("continueCodeFixIt")
                  : void 0);
              ...
              (0, ai.saveAs)(
                i,
                `${e}-${new Date().toISOString().split("T")[0]}.json`
              );
            }
            restore(e) {
              return (0, ii.D)(
                  ...
                  .then((n) => {
                    ...
                    w.version === this.VERSION
                      ? (this.restoreLocalStorage(
                          "displayedDifficulties",
                          null === (i = w.scoreBoard) || void 0 === i
                            ? void 0
                            : i.displayedDifficulties
                        ),
                        this.restoreLocalStorage(
                          "showSolvedChallenges",
                          null === (r = w.scoreBoard) || void 0 === r
                            ? void 0
                            : r.showSolvedChallenges
                        ),
                        this.restoreLocalStorage(
                          "showDisabledChallenges",
                          null === (l = w.scoreBoard) || void 0 === l
                            ? void 0
                            : l.showDisabledChallenges
                        ),
                        this.restoreLocalStorage(
                          "showOnlyTutorialChallenges",
                          null === (u = w.scoreBoard) || void 0 === u
                            ? void 0
                            : u.showOnlyTutorialChallenges
                        ),
                        this.restoreLocalStorage(
                          "displayedChallengeCategories",
                          null === (f = w.scoreBoard) || void 0 === f
                            ? void 0
                            : f.displayedChallengeCategories
                        ),
                        this.restoreCookie(
                          "welcomebanner_status",
                          null === (b = w.banners) || void 0 === b
                            ? void 0
                            : b.welcomeBannerStatus
                        ),
                        this.restoreCookie(
                          "cookieconsent_status",
                          null === (S = w.banners) || void 0 === S
                            ? void 0
                            : S.cookieConsentStatus
                        ),
                        this.restoreCookie("language", w.language),
                        this.restoreCookie(
                          "continueCodeFindIt",
                          w.continueCodeFindIt
                        ),
                        this.restoreCookie(
                          "continueCodeFixIt",
                          w.continueCodeFixIt
                        ),
                        this.restoreCookie("continueCode", w.continueCode),
                        this.snackBar
                          .open(
                            "Backup has been restored from " + e.name,
                            "Apply changes now",
                            { duration: 1e4 }
                          )
                          .onAction()
                          .subscribe(() => {
                            const tt = w.continueCode
                                ? this.challengeService.restoreProgress(
                                    encodeURIComponent(w.continueCode)
                                  )
                                : (0, _t.of)(!0),
                              et = w.continueCodeFindIt
                                ? this.challengeService.restoreProgressFindIt(
                                    encodeURIComponent(w.continueCodeFindIt)
                                  )
                                : (0, _t.of)(!0),
                              Fu = w.continueCodeFixIt
                                ? this.challengeService.restoreProgressFixIt(
                                    encodeURIComponent(w.continueCodeFixIt)
                                  )
                                : (0, _t.of)(!0);
                      ...
                      : this.snackBarHelperService.open(
                          `Version ${w.version} is incompatible with expected version ${this.VERSION}`,
                          "errorBar"
                        );
                  })
                  .catch((n) => {
                    this.snackBarHelperService.open(
                      `Backup restore operation failed: ${n.message}`,
                      "errorBar"
                    );
                  })
              );
            ...
            restoreCookie(e, n) {
              if (n) {
                ...
                i.setFullYear(i.getFullYear() + 1),
                  this.cookieService.put(e, n, { expires: i });
        ...
        si = (() => {
          class o {
            ...
            check(e, n) {
              return this.http.post(this.host, { key: e, selectedFix: n }).pipe(
                (0, _.U)((i) => i),
                (0, m.K)((i) => {
                  throw i;
                })
        ...
        li = (() => {
          class o {
            ...
            check(e, n) {
              return this.http
                .post(this.host, { key: e, selectedLines: n })
                .pipe(
                  (0, _.U)((i) => i),
                  (0, m.K)((i) => {
                    throw i;
      ...
      let ui = (() => {
        class o {
          ...
          ngOnInit() {
            this.lineMarkers = this.code
              .split("\n")
              .map((e, n) => ({ lineNumber: n + 1, marked: !1 }));
          }
          selectLines(e) {
        ...
        return (
          ...
          (o.ɵcmp = t.Xpm({
            ...
            inputs: { code: "code", vulnLines: "vulnLines" },
            outputs: { addLine: "addLine" },
            decls: 6,
            vars: 4,
            consts: [
              ["id", "code-area"],
            ...
            template: function (e, n) {
              1 & e &&
                (t.TgZ(0, "div", 0)(1, "pre", 1)(2, "div", 2),
                t.YNc(3, ci, 2, 2, "div", 3),
                t._uU(4, "\n  "),
                t.qZA(),
                t._UZ(5, "code", 4),
                t.qZA()()),
                2 & e &&
                  ...
                  t.xp6(2),
                  t.Q6J("highlight", n.code)("lineNumbers", !0)(
                    "languages",
                    n.langs
                  ));
            },
      ...
      function pi(o, a) {
        if (
          (1 & o && (t.TgZ(0, "div"), t._UZ(1, "td-ngx-text-diff", 8), t.qZA()),
          2 & o)
        ) {
          const e = t.oxw().$implicit,
            n = t.oxw();
      ...
      function mi(o, a) {
        if (
          (1 & o && (t.TgZ(0, "div", 6), t.YNc(1, pi, 2, 2, "div", 7), t.qZA()),
          2 & o)
        ) {
          const e = a.index,
            n = t.oxw();
        ...
        class o {
          ...
          shuffle() {
            ...
            for (const i of this.fixes)
              this.randomFixes.push({ fix: i, index: e }), e++;
          ...
          (o.ɵcmp = t.Xpm({
            ...
            template: function (e, n) {
              1 & e &&
                ...
                t.YNc(6, di, 2, 3, "option", 3),
                t.qZA()(),
                t.YNc(7, mi, 2, 1, "div", 4),
                t._UZ(8, "br"),
                t.qZA()),
                2 & e &&
                  (t.xp6(6),
      ...
      function _i(o, a) {
        ...
        if (2 & o) {
          const e = t.oxw();
          t.Q6J("code", null == e.snippet ? null : e.snippet.snippet)(
            "vulnLines",
            null == e.snippet ? null : e.snippet.vulnLines
          );
        }
      }
      function gi(o, a) {
      ...
      function vi(o, a) {
        ...
        if (2 & o) {
          const e = t.oxw();
          t.Q6J("snippet", null == e.snippet ? null : e.snippet.snippet)(
            "fixes",
            e.fixes
          );
        }
      ...
      function bi(o, a) {
        if (
          (1 & o &&
            (t.TgZ(0, "a", 26)(1, "button", 27)(2, "mat-icon", 28),
            t._uU(3, "thumb_up"),
            t.qZA()()()),
          2 & o)
        ) {
          ...
          t.Q6J(
            ...
            "https://docs.google.com/forms/d/e/1FAIpQLSdaNEuz0dzFA2sexCa0AJ4QOb2OYdEL04eQOLFD2Y4T-BW6ag/viewform?usp=pp_url&entry.384948954=" +
              e.dialogData.name +
              "&entry.435235279=Coding+Challenge&entry.1734944650=Yes",
            t.LSH
          );
        }
      }
      function xi(o, a) {
        if (
          (1 & o &&
            (t.TgZ(0, "a", 26)(1, "button", 27)(2, "mat-icon", 29),
            t._uU(3, "thumb_down"),
            t.qZA()()()),
          2 & o)
        ) {
          ...
          t.Q6J(
            ...
            "https://docs.google.com/forms/d/e/1FAIpQLSdaNEuz0dzFA2sexCa0AJ4QOb2OYdEL04eQOLFD2Y4T-BW6ag/viewform?usp=pp_url&entry.384948954=" +
              e.dialogData.name +
              "&entry.435235279=Coding+Challenge&entry.1734944650=No",
            t.LSH
          );
        }
      }
            ...
            (this.dialogData = e),
              ...
              (this.checkFix = () => {
                this.codeFixesService
                  .check(this.dialogData.key, this.selectedFix)
                  .subscribe((b) => {
                        ...
                        ? ((this.solved.findIt = !0),
                          this.challengeService.continueCodeFindIt().subscribe(
                            (S) => {
                              if (!S)
                                throw new Error(
                                  "Received invalid continue code from the sever!"
                                );
                              const w = new Date();
                        ...
                        : ((this.solved.fixIt = !0),
                          this.challengeService.continueCodeFixIt().subscribe(
                            (S) => {
                              ...
                              const w = new Date();
                              w.setFullYear(w.getFullYear() + 1),
                                this.cookieService.put("continueCodeFixIt", S, {
                                  expires: w,
                                });
                            },
                            (S) => console.log(S)
            ...
            this.configurationService.getApplicationConfiguration().subscribe(
              ...
              this.codeSnippetService.get(this.dialogData.key).subscribe(
                (e) => {
                  (this.snippet = e),
                    ...
                    this.dialogData.codingChallengeStatus >= 1 &&
                      ((this.result = E.Right),
                      (this.lock = E.Right),
                      (this.solved.findIt = !0));
                },
                (e) => {
                  this.snippet = { snippet: e.error };
                }
              ),
              this.codeFixesService.get(this.dialogData.key).subscribe(
                (e) => {
                  (this.fixes = e.fixes),
                    (this.solved.fixIt =
                      this.dialogData.codingChallengeStatus >= 2);
                },
                () => {
                  this.fixes = null;
                }
          ...
          (o.ɵcmp = t.Xpm({
            ...
            template: function (e, n) {
              1 & e &&
                ...
                t.YNc(10, _i, 1, 2, "app-code-area", 5),
                t.YNc(11, gi, 5, 0, "pre", 6),
                t.qZA(),
                t.YNc(12, fi, 2, 1, "mat-card", 7),
                t.qZA(),
                ...
                t.qZA()(),
                t.TgZ(28, "mat-tab", 14),
                t.YNc(29, Ci, 4, 5, "ng-template", 15),
                t.TgZ(30, "div", 3)(31, "div", 4),
                t.YNc(32, vi, 1, 2, "app-code-fixes", 16),
                t.qZA(),
                t.YNc(33, Ti, 2, 3, "mat-card", 17),
                t.qZA(),
                t.TgZ(34, "mat-dialog-actions", 8),
                t._UZ(35, "button", 9),
                t.YNc(36, bi, 4, 1, "a", 18),
                t.YNc(37, xi, 4, 1, "a", 18),
                ...
                2 & e &&
                  ...
                  t.AsE(
                    "",
                    t.lcZ(4, 24, "TITLE_CODING_CHALLENGE"),
                    ": ",
                    n.dialogData.name,
                    ""
                  ),
            ...
            styles: [
              ".stretched-tabs[_ngcontent-%COMP%]{max-width:600px}#code-snippet[_ngcontent-%COMP%]{width:65em}.dialogAction[_ngcontent-%COMP%]{margin-bottom:0!important}",
            ],
          })),
          o
        );
      ...
      function Zi(o, a) {
        ...
        if (2 & o) {
          const e = t.oxw();
          t.Q6J("id", e.challenge.name + ".solved")(
            "matTooltip",
            e.allowRepeatNotifications
              ? t.lcZ(1, 5, "NOTIFICATION_RESEND_INSTRUCTIONS")
              : null
          ),
            t.xp6(2),
      ...
      function wi(o, a) {
        ...
        if (2 & o) {
          const e = t.oxw();
          t.Q6J("id", e.challenge.name + ".notSolved")(
            "matTooltip",
            e.showChallengeHints ? e.challenge.hint : null
          ),
            t.xp6(1),
      ...
      function Si(o, a) {
        if ((1 & o && t._UZ(0, "i"), 2 & o)) {
          ...
          t.Tol(
            "icon-" +
              (null == e.challenge.disabledEnv
                ? null
                : e.challenge.disabledEnv.toString().toLowerCase())
          );
        }
      }
      function yi(o, a) {
      ...
      function Ii(o, a) {
        if (
          ...
          const e = t.oxw();
          t.Q6J("id", e.challenge.name + ".unavailable")(
            "matTooltip",
            e.challenge.hint
          ),
            t.xp6(2),
      ...
      let Ui = (() => {
        class o {
          ...
          repeatNotification() {
            this.allowRepeatNotifications &&
              this.challengeService
                .repeatNotification(encodeURIComponent(this.challenge.name))
                .subscribe(
                  () => {
          ...
          openHint() {
            this.showChallengeHints &&
              this.challenge.hintUrl &&
        ...
        return (
          ...
          (o.ɵcmp = t.Xpm({
            ...
            template: function (e, n) {
              1 & e &&
                (t.YNc(0, Zi, 9, 9, "button", 0),
                t.YNc(1, wi, 8, 7, "button", 1),
                t.YNc(2, Ii, 6, 7, "button", 2)),
                2 & e &&
                  (t.Q6J(
                    "ngIf",
                    !n.challenge.disabledEnv && n.challenge.solved
                  ),
                  t.xp6(1),
                  t.Q6J(
                    "ngIf",
      ...
      function Pi(o, a) {
        ...
        if (2 & o) {
          const e = a.$implicit,
            n = t.oxw();
          t.Q6J("checked", n.displayedDifficulties.includes(e))(
            "disabled",
            n.restrictToTutorialsFirst && e > n.tutorialsTier
          )(
            "matTooltip",
            n.restrictToTutorialsFirst &&
              !n.allTutorialsCompleted &&
              e > n.tutorialsTier
              ? n.isLastTutorialsTier
                ? t.xi3(
                    1,
                    13,
                    "INFO_FULL_CHALLENGE_MODE",
                    t.VKq(19, lt, n.challenges.length)
                  )
                : t.xi3(
                    2,
                    16,
                    "INFO_NEXT_TUTORIAL_TIER",
                    t.VKq(21, Oi, "\u2605".repeat(n.tutorialsTier))
                  )
              : ""
          ),
            t.xp6(5),
            ...
            t.Tol(
              "fa-layers-counter " +
                (n.solvedChallengesOfDifficulty[e - 1].length ===
                n.totalChallengesOfDifficulty[e - 1].length
                  ? "accent-notification"
                  : 0 === n.solvedChallengesOfDifficulty[e - 1].length
                  ? "warn-notification"
      ...
      function Li(o, a) {
        ...
        if (2 & o) {
          const e = t.oxw();
          t.Q6J("checked", e.showOnlyTutorialChallenges)(
            "disabled",
            e.restrictToTutorialsFirst && !e.allTutorialsCompleted
          )(
            "matTooltip",
            e.restrictToTutorialsFirst && !e.allTutorialsCompleted
              ? t.xi3(
                  ...
                  4,
                  "INFO_FULL_CHALLENGE_MODE",
                  t.VKq(9, lt, e.challenges.length)
                )
              : ""
          ),
            t.xp6(4),
      ...
      function Ni(o, a) {
        ...
        if (2 & o) {
          const e = t.oxw();
          t.Q6J("checked", e.showDisabledChallenges)(
            "disabled",
            e.restrictToTutorialsFirst && !e.allTutorialsCompleted
          )(
            "matTooltip",
        ...
        if ((1 & o && (t._UZ(0, "div", 37), t.ALo(1, "translate")), 2 & o)) {
          ...
          t.Q6J(
            ...
            t.xi3(
              1,
              1,
              "INFO_DISABLED_CHALLENGES",
              t.WLB(4, Mi, e.numDisabledChallenges, e.disabledEnv)
            ),
            t.oJD
          );
        }
      ...
      function Fi(o, a) {
        ...
        if (2 & o) {
          const e = a.$implicit,
            n = t.oxw();
          t.Q6J("checked", n.displayedChallengeCategories.includes(e))(
            "disabled",
            n.restrictToTutorialsFirst && !n.allTutorialsCompleted
          )(
            "matTooltip",
            n.restrictToTutorialsFirst && !n.allTutorialsCompleted
              ? t.xi3(
                  ...
                  4,
                  "INFO_FULL_CHALLENGE_MODE",
                  t.VKq(11, lt, n.challenges.length)
                )
              : t.lcZ(
                  2,
                  7,
                  "CATEGORY_" +
                    (null == e ? null : e.toUpperCase().split(" ").join("_")) +
                    "_DESCRIPTION"
                )
          ),
            t.xp6(3),
      ...
      function Ri(o, a) {
        1 & o &&
          (t.TgZ(0, "mat-header-cell", 59), t._uU(1, "LABEL_NAME"), t.qZA());
      }
      function Yi(o, a) {
        if ((1 & o && (t.TgZ(0, "mat-cell"), t._uU(1), t.qZA()), 2 & o)) {
          const e = a.$implicit;
      ...
      function Hi(o, a) {
        1 & o &&
          (t.TgZ(0, "mat-header-cell", 63),
          t._uU(1, "LABEL_DESCRIPTION "),
          t.qZA());
      }
      function Gi(o, a) {
        if (
          (1 & o && (t.TgZ(0, "mat-cell", 64), t._UZ(1, "div", 65), t.qZA()),
          2 & o)
        ) {
          const e = a.$implicit;
            ...
            t.hij(
              ...
              t.lcZ(
                ...
                "CATEGORY_" +
                  (null == e.category
                    ? null
                    : e.category.toUpperCase().split(" ").join("_"))
              ),
              " "
            );
        }
      ...
      function Ki(o, a) {
        1 & o &&
          (t.TgZ(0, "mat-header-cell", 68), t._uU(1, "LABEL_TAGS"), t.qZA());
      }
      function Wi(o, a) {
        if (
          (1 & o &&
            (t.TgZ(0, "mat-chip-list")(1, "mat-chip", 70),
            t.ALo(2, "translate"),
            t._uU(3),
            t.ALo(4, "translate"),
            t.qZA()()),
      ...
      function $i(o, a) {
        if (
          (1 & o &&
            (t.TgZ(0, "span"),
            t.YNc(1, Wi, 5, 6, "mat-chip-list", 62),
            t.qZA()),
          2 & o)
        ) {
          const e = t.oxw().$implicit;
      ...
      function Vi(o, a) {
        if (
          (1 & o &&
            (t.TgZ(0, "mat-cell", 69), t.YNc(1, $i, 2, 1, "span", 5), t.qZA()),
          2 & o)
        ) {
          const e = a.$implicit;
      ...
      function Xi(o, a) {
        1 & o &&
          (t.TgZ(0, "mat-header-cell", 59), t._uU(1, "LABEL_STATUS"), t.qZA());
      }
      function tr(o, a) {
        if (1 & o) {
          const e = t.EpF();
      ...
      function er(o, a) {
        if (
          ...
          t.Q6J("href", e.mitigationUrl, t.LSH),
            ...
            t.Q6J(
              "matTooltip",
              t.lcZ(2, 2, "INFO_VULNERABILITY_MITIGATION_LINK")
            );
        }
      }
      function or(o, a) {
          ...
          t.TgZ(0, "button", 80),
            t.NdJ("click", function () {
              ...
              const i = t.oxw().$implicit,
                r = t.oxw(2);
              return t.KtG(
                r.showCodeSnippet(i.key, i.name, i.codingChallengeStatus)
              );
            }),
            t.ALo(1, "translate"),
            t.TgZ(2, "mat-icon", 81),
        ...
        if (2 & o) {
          ...
          t.Q6J(
            "disabled",
            "solved" === n.codingChallengesEnabled && !e.solved
          )("matTooltip", t.lcZ(1, 5, "LAUNCH_CODING_CHALLENGE"))(
            "color",
            n.generateColor(e)
          )("id", e.name + ".codingChallengeButton"),
            t.xp6(2),
      ...
      function ar(o, a) {
        if (
          (1 & o &&
            (t.TgZ(0, "mat-cell"),
            t._UZ(1, "app-challenge-status-badge", 71),
            t.YNc(2, tr, 4, 3, "button", 72),
            t.YNc(3, er, 5, 4, "a", 73),
            t.TgZ(4, "div", 74),
            t.ALo(5, "translate"),
            t.YNc(6, or, 4, 7, "button", 75),
            t.qZA(),
            t.YNc(7, nr, 4, 3, "button", 76),
            t.qZA()),
          2 & o)
        ) {
          const e = a.$implicit,
          ...
          t.xp6(1),
            t.Q6J("challenge", e)(
              ...
              n.allowRepeatNotifications
            )("showChallengeHints", n.showChallengeHints),
            t.xp6(1),
            t.Q6J(
              "ngIf",
              n.showHackingInstructor &&
                !e.solved &&
                !e.disabledEnv &&
                e.hasTutorial
            ),
            ...
            t.Q6J(
              "ngIf",
              n.showVulnerabilityMitigations && e.solved && e.mitigationUrl
            ),
            t.xp6(1),
            t.Q6J("matTooltip", t.lcZ(5, 9, "SOLVE_HACKING_CHALLENGE"))(
              "matTooltipDisabled",
              !e.hasSnippet ||
                ("solved" === n.codingChallengesEnabled && e.solved) ||
                "always" === n.codingChallengesEnabled
            ),
            t.xp6(2),
            t.Q6J(
              "ngIf",
              e.hasSnippet && "never" !== n.codingChallengesEnabled
            ),
            t.xp6(1),
            t.Q6J(
              "ngIf",
              "scoreBoardChallenge" === e.key &&
                n.showHackingInstructor &&
                e.solved &&
                "never" !== n.codingChallengesEnabled &&
                e.codingChallengeStatus < 1
            );
        }
      }
      function ir(o, a) {
        1 & o &&
          (t.TgZ(0, "mat-header-cell", 87),
      ...
      function rr(o, a) {
        if (
          (1 & o &&
            (t.TgZ(0, "a", 78)(1, "button", 89)(2, "mat-icon", 90),
            t._uU(3, "thumb_up"),
            t.qZA()()()),
          2 & o)
        ) {
          ...
          t.Q6J(
            ...
            "https://docs.google.com/forms/d/e/1FAIpQLSdaNEuz0dzFA2sexCa0AJ4QOb2OYdEL04eQOLFD2Y4T-BW6ag/viewform?usp=pp_url&entry.384948954=" +
              e.name +
              "&entry.435235279=Hacking+Challenge&entry.1734944650=Yes",
            t.LSH
          );
        }
      }
      function sr(o, a) {
        if (
          (1 & o &&
            (t.TgZ(0, "a", 78)(1, "button", 89)(2, "mat-icon", 91),
            t._uU(3, "thumb_down"),
            t.qZA()()()),
          2 & o)
        ) {
          ...
          t.Q6J(
            ...
            "https://docs.google.com/forms/d/e/1FAIpQLSdaNEuz0dzFA2sexCa0AJ4QOb2OYdEL04eQOLFD2Y4T-BW6ag/viewform?usp=pp_url&entry.384948954=" +
              e.name +
              "&entry.435235279=Hacking+Challenge&entry.1734944650=No",
            t.LSH
          );
        }
      }
      ...
      function cr(o, a) {
        1 & o &&
          (t.ynx(0, 84),
          t.YNc(1, ir, 2, 0, "mat-header-cell", 85),
          t.YNc(2, lr, 3, 2, "mat-cell", 86),
          t.BQk());
      }
      function ur(o, a) {
        1 & o && t._UZ(0, "mat-header-row");
      ...
      function pr(o, a) {
        if (
          (1 & o &&
            (t.TgZ(0, "mat-table", 39),
            t.ynx(1, 40),
            t.YNc(2, Ri, 2, 0, "mat-header-cell", 41),
            t.YNc(3, Yi, 2, 1, "mat-cell", 42),
            t.BQk(),
            t.ynx(4, 43),
            t.YNc(5, Bi, 2, 0, "mat-header-cell", 44),
            t.YNc(6, Qi, 2, 1, "mat-cell", 45),
            t.BQk(),
            t.ynx(7, 46),
            t.YNc(8, Hi, 2, 0, "mat-header-cell", 47),
            t.YNc(9, Gi, 2, 1, "mat-cell", 48),
            t.BQk(),
            t.ynx(10, 49),
            t.YNc(11, ji, 2, 0, "mat-header-cell", 50),
            t.YNc(12, zi, 3, 3, "mat-cell", 51),
            t.BQk(),
            t.ynx(13, 52),
            t.YNc(14, Ki, 2, 0, "mat-header-cell", 53),
            t.YNc(15, Vi, 2, 1, "mat-cell", 54),
            t.BQk(),
            t.ynx(16, 55),
            t.YNc(17, Xi, 2, 0, "mat-header-cell", 41),
            t.YNc(18, ar, 8, 11, "mat-cell", 42),
            t.BQk(),
            t.YNc(19, cr, 3, 0, "ng-container", 56),
            t.YNc(20, ur, 1, 0, "mat-header-row", 57),
            t.YNc(21, dr, 1, 0, "mat-row", 58),
            t.qZA()),
          2 & o)
        ) {
          const e = t.oxw();
          t.Q6J("dataSource", e.filterToDataSource(e.challenges))(
            "trackBy",
            e.trackById
          ),
            t.xp6(19),
      ...
      function mr(o, a) {
        1 & o && (t._UZ(0, "mat-card", 96), t.ALo(1, "translate")),
          2 & o &&
            t.Q6J("innerHTML", t.lcZ(1, 1, "CALL_FOR_CONTRIBUTIONS"), t.oJD);
      }
      const hr = function (o, a) {
        return { appname: o, questionnaire: a };
      };
      function _r(o, a) {
        if (
          (1 & o && (t._UZ(0, "mat-card", 97), t.ALo(1, "translate")), 2 & o)
        ) {
          const e = t.oxw(2);
          t.Q6J(
            "innerHTML",
            t.xi3(
              ...
              1,
              "CALL_FOR_FEEDBACK",
              t.WLB(4, hr, e.appName, e.questionnaireUrl)
            ),
            t.oJD
          );
        }
      ...
      function gr(o, a) {
        if (
          (1 & o &&
            (t.TgZ(0, "div", 92),
            t.YNc(1, mr, 2, 3, "mat-card", 93),
            t._UZ(2, "span", 94),
            t.YNc(3, _r, 2, 7, "mat-card", 95),
            t.qZA()),
          2 & o)
        ) {
          const e = t.oxw();
      ...
      let fr = (() => {
          class o {
            ...
            ngOnInit() {
              this.spinner.show(),
                (this.displayedDifficulties = localStorage.getItem(
                  "displayedDifficulties"
                )
                  ? JSON.parse(
                      String(localStorage.getItem("displayedDifficulties"))
                ...
                (this.showSolvedChallenges =
                  !localStorage.getItem("showSolvedChallenges") ||
                  JSON.parse(
                    String(localStorage.getItem("showSolvedChallenges"))
                  )),
                (this.showDisabledChallenges =
                  !!localStorage.getItem("showDisabledChallenges") &&
                  JSON.parse(
                    String(localStorage.getItem("showDisabledChallenges"))
                  )),
                this.configurationService
                  ...
                  .subscribe(
                    (e) => {
                      var n, i, r;
                      (this.allowRepeatNotifications =
                        e.challenges.showSolvedNotifications &&
                        (null === (n = e.ctf) || void 0 === n
                          ? void 0
                          : n.showFlagsInNotifications)),
                        (this.showChallengeHints = e.challenges.showHints),
                        (this.showVulnerabilityMitigations =
                          e.challenges.showMitigations),
                        (this.codingChallengesEnabled =
                          e.challenges.codingChallengesEnabled),
                        (this.showHackingInstructor =
                          null === (i = e.hackingInstructor) || void 0 === i
                            ? void 0
                            : i.isEnabled),
                        (this.showContributionInfoBox =
                          e.application.showGitHubLinks),
                        (this.showFeedbackButtons =
                          e.challenges.showFeedbackButtons),
                        this.showFeedbackButtons &&
                          this.displayedColumns.push("feedback"),
                        (this.questionnaireUrl =
                          null === (r = e.application.social) || void 0 === r
                            ? void 0
                            : r.questionnaireUrl),
                        (this.appName = e.application.name),
                        (this.restrictToTutorialsFirst =
                          e.challenges.restrictToTutorialsFirst),
                        ...
                        (this.localBackupEnabled =
                          e.application.localBackupEnabled),
                              ...
                              .subscribe((u) => {
                                ...
                                for (let f = 0; f < this.challenges.length; f++)
                                  this.augmentHintText(this.challenges[f]),
                                    ...
                                    "Score Board" === this.challenges[f].name &&
                                      (this.challenges[f].solved = !0),
                                    ...
                                    this.showHackingInstructor &&
                                      d
                                        ...
                                        .then(d.bind(d, 3907))
                                        .then((b) => {
                                          l[f].hasTutorial = b.hasInstructions(
                                            l[f].name
                                          );
                                        }),
                                    (l[f].hasSnippet =
                                      u.indexOf(l[f].key) > -1);
                                this.availableChallengeCategories.sort((f, b) =>
                                  f.localeCompare(b)
                                ),
                                  (this.displayedChallengeCategories =
                                    localStorage.getItem(
                                  ...
                                  this.showOnlyTutorialChallenges &&
                                    this.challenges.sort(
                                      (f, b) =>
                                        f.tutorialOrder - b.tutorialOrder
                                    ),
                                  this.spinner.hide();
                              });
                          },
            ...
            augmentHintText(e) {
              e.disabledEnv
                ? (this.numDisabledChallenges++,
                  ...
                  this.translate
                    .get("CHALLENGE_UNAVAILABLE", { env: e.disabledEnv })
                    .subscribe(
                      (n) => {
                        e.hint = n;
                      },
            ...
            trustDescriptionHtml(e) {
              e.description = this.sanitizer.bypassSecurityTrustHtml(
                e.description
              );
            }
            calculateCodingProgressPercentage() {
              ...
              for (let i = 0; i < this.challenges.length; i++)
                this.challenges[i].hasSnippet &&
                  (e++, (n += this.challenges[i].codingChallengeStatus));
            ...
            calculateTutorialTier(e) {
              ...
              for (let n = 1; n <= 6; n++) {
                const i = e.filter(
                    (l) => l.tutorialOrder && l.difficulty === n
                  ).length,
                  r = e.filter(
                    (l) => l.tutorialOrder && l.difficulty === n && l.solved
                  ).length;
                (this.allTutorialsCompleted =
                  this.allTutorialsCompleted && i === r),
                ...
                this.isLastTutorialsTier =
                  ...
                  e.filter(
                    (n) =>
                      n.tutorialOrder &&
                      !n.solved &&
                      n.difficulty > this.tutorialsTier
                  ).length;
                for (let n = 1; n <= this.tutorialsTier; n++)
                  this.displayedDifficulties.includes(n) ||
            ...
            calculateGradientOffset(e, n) {
              ...
              for (let u = 0; u < e.length; u++)
                e[u].difficulty === n && (r++, e[u].solved && i++);
              let l = Math.round((100 * i) / r);
              return (l = 100 - l), +l + "%";
            }
            toggleDifficulty(e) {
              this.displayedDifficulties.includes(e)
                ? (this.displayedDifficulties =
                    this.displayedDifficulties.filter((n) => n !== e))
                : this.displayedDifficulties.push(e),
            ...
            toggleShowOnlyTutorialChallenges() {
              (this.showOnlyTutorialChallenges =
                ...
                this.challenges.sort(
                  this.showOnlyTutorialChallenges
                    ? (e, n) => e.tutorialOrder - n.tutorialOrder
                    : (e, n) => (e.name < n.name ? -1 : e.name > n.name ? 1 : 0)
                );
            }
            toggleShowChallengeCategory(e) {
              this.displayedChallengeCategories.includes(e)
                ? (this.displayedChallengeCategories =
                    this.displayedChallengeCategories.filter((n) => n !== e))
                : this.displayedChallengeCategories.push(e),
                localStorage.setItem(
                  "displayedChallengeCategories",
            ...
            toggleAllChallengeCategory() {
              this.toggledMajorityOfCategories
                ? ((this.displayedChallengeCategories = []),
                  (this.toggledMajorityOfCategories = !1))
                : ((this.displayedChallengeCategories =
                    this.availableChallengeCategories),
                  (this.toggledMajorityOfCategories = !0)),
                localStorage.setItem(
            ...
            determineToggledMajorityOfDifficulties() {
              return (
                this.displayedDifficulties.length >
            ...
            filterToDataSource(e) {
              e = e.filter(
                (i) =>
                  !(
                    !this.displayedDifficulties.includes(i.difficulty) ||
                    !this.displayedChallengeCategories.includes(i.category) ||
                    (!this.showSolvedChallenges && i.solved) ||
                    (!this.showDisabledChallenges && i.disabledEnv) ||
                    (this.showOnlyTutorialChallenges && !i.hasTutorial)
                  )
              );
              const n = new c.by();
              return (n.data = e), n;
            ...
            populateFilteredChallengeLists() {
              for (const e of this.availableDifficulties)
                0 === this.challenges.length
                  ? ((this.totalChallengesOfDifficulty[e - 1] = []),
                    (this.solvedChallengesOfDifficulty[e - 1] = []))
                  : ((this.totalChallengesOfDifficulty[e - 1] =
                      this.challenges.filter((n) => n.difficulty === e)),
                    (this.solvedChallengesOfDifficulty[e - 1] =
                      this.challenges.filter(
                        (n) => n.difficulty === e && n.solved
                      )));
            }
            startHackingInstructor(e) {
              console.log(`Starting instructions for challenge "${e}"`),
            ...
            showCodeSnippet(e, n, i) {
              this.dialog
                .open(Ai, {
                  disableClose: !0,
                  data: { key: e, name: n, codingChallengeStatus: i },
                })
                .afterClosed()
                .subscribe((l) => {
                  for (const u of this.challenges)
                    u.name === n &&
                      (u.codingChallengeStatus < 1 &&
                        (u.codingChallengeStatus = l.findIt
                          ? 1
                          : u.codingChallengeStatus),
                      u.codingChallengeStatus < 2 &&
                        (u.codingChallengeStatus = l.fixIt
                          ? 2
                          : u.codingChallengeStatus),
                      this.calculateCodingProgressPercentage());
                });
          ...
          return (
            ...
            (o.ɵcmp = t.Xpm({
              ...
              consts: [
                ...
                [
                  "id",
                  "btnToggleShowOnlyTutorialChallenges",
                  "matTooltipPosition",
                  "above",
                  3,
                  "checked",
                ...
                [
                  ...
                  "primary",
                  "aria-label",
                  "Button to restore local backup",
                  "matTooltipPosition",
                  "above",
                  3,
                  "matTooltip",
                ...
                [
                  "class",
                  "disabled-challenges-infoBox mat-button",
                  3,
                  "innerHTML",
                  4,
                  "ngIf",
                ...
                [
                  ...
                  "above",
                  1,
                  "vulnerability-mitigation-button",
                  3,
                  "matTooltip",
                ],
                [
              ...
              template: function (e, n) {
                1 & e &&
                  (t.TgZ(0, "div", 0)(1, "div", 1)(2, "mat-card", 2)(
                    3,
                    "mat-card-title"
                  ),
                  t._uU(4),
                  ...
                  t.qZA(),
                  t.YNc(9, ki, 7, 6, "mat-card", 5),
                  t.qZA(),
                  t.TgZ(10, "mat-card")(11, "div", 6),
                  t.YNc(12, Pi, 14, 23, "mat-button-toggle", 7),
                  t.TgZ(13, "button", 8),
                  t.NdJ("click", function () {
                  ...
                  t.ALo(20, "translate"),
                  t.qZA(),
                  t.YNc(21, Li, 6, 11, "mat-button-toggle", 11),
                  t.YNc(22, Ni, 5, 11, "mat-button-toggle", 12),
                  t.YNc(23, Ei, 4, 3, "button", 13),
                  t.TgZ(24, "div", 14)(25, "input", 15, 16),
                  t.NdJ("change", function (r) {
                    return n.restoreBackup(r.target.files.item(0));
                  }),
                  t.qZA()(),
                  t.YNc(27, qi, 4, 3, "button", 17),
                  t.YNc(28, Di, 2, 7, "div", 18),
                  t.qZA(),
                  t._UZ(29, "mat-divider"),
                  t.TgZ(30, "div", 19),
                  t.YNc(31, Fi, 5, 13, "mat-button-toggle", 20),
                  t.TgZ(32, "button", 21),
                  t.NdJ("click", function () {
                  ...
                  t.qZA()()(),
                  t.TgZ(35, "mat-card"),
                  t.YNc(36, pr, 22, 5, "mat-table", 22),
                  t.qZA(),
                  t.YNc(37, gr, 4, 2, "div", 23),
                  t.qZA(),
                  ...
                  2 & e &&
                    ...
                    t.Oqu(
                      t.lcZ(
                        15,
                        24,
                        n.toggledMajorityOfDifficulties
                          ? "BTN_HIDE_ALL"
                          : "BTN_SHOW_ALL"
                      )
                    ),
                    t.xp6(2),
                    t.Q6J("checked", n.showSolvedChallenges)(
                      "disabled",
                      n.restrictToTutorialsFirst && !n.allTutorialsCompleted
                    )(
                      "matTooltip",
                      n.restrictToTutorialsFirst && !n.allTutorialsCompleted
                        ? t.xi3(
                            ...
                            26,
                            "INFO_FULL_CHALLENGE_MODE",
                            t.VKq(33, lt, n.challenges.length)
                          )
                        : ""
                    ),
                    t.xp6(3),
                    ...
                    t.Q6J(
                      "ngIf",
                      n.numDisabledChallenges > 0 && n.showDisabledChallenges
                    ),
                    t.xp6(3),
                    ...
                    t.Q6J(
                      "ngIf",
                      n.showContributionInfoBox || n.questionnaireUrl
                    ));
              },
              dependencies: [
                T.sg,
        ...
        class o {
          ...
          verify() {
            ...
            this.twoFactorAuthService
              .verify(this.twoFactorForm.value.token)
              .subscribe(
                (i) => {
                  var r;
                  localStorage.setItem("token", i.token);
                  ...
                  l.setHours(l.getHours() + 8),
                    this.cookieService.put("token", i.token, { expires: l }),
                    sessionStorage.setItem(
                      "bid",
                      null === (r = i.bid) || void 0 === r
                        ? void 0
                        : r.toString()
                    ),
                    this.userService.isLoggedIn.next(!0),
          ...
          (o.ɵcmp = t.Xpm({
            ...
            consts: [
              ...
              [
                ...
                "totpToken",
                "aria-label",
                "Field for entering the Two Factor token",
                3,
                "placeholder",
              ],
              ["tokenInput", ""],
              [
                ...
                "right",
                "aria-label",
                "The code to be entered from the authenticator must have 6 digits.",
                3,
                "matTooltip",
              ],
              ["align", "end"],
            ...
            template: function (e, n) {
              if (
                ...
                t.xp6(6),
                  ...
                  t.s9C(
                    "placeholder",
                    t.lcZ(14, 7, "2FA_ENTER_CODE_PLACEHOLDER")
                  ),
                  t.xp6(3),
            ...
            styles: [
              "mat-card[_ngcontent-%COMP%]{height:auto;min-width:320px;width:25%}#totpSubmitButton[_ngcontent-%COMP%]{margin-left:20%;margin-top:30px;width:60%}#inputToken[_ngcontent-%COMP%]{width:100%}",
            ],
          })),
          o
        );
      ...
      let Tr = (() => {
        class o {
          ...
          ngOnInit() {
            ...
            e &&
              this.translate.get(e).subscribe(
                (n) => {
                  this.error = n;
                },
                (n) => {
        ...
        return (
          ...
          (o.ɵcmp = t.Xpm({
            ...
            template: function (e, n) {
              1 & e &&
                (t.TgZ(0, "mat-card", 0)(1, "div")(2, "div", 1),
                t._UZ(3, "i", 2),
                t._uU(4, " 403"),
                t.qZA(),
                t.TgZ(5, "span", 3),
                t._uU(6),
                t.qZA()()()),
                2 & e && (t.xp6(6), t.Oqu(n.error));
            },
            dependencies: [x.a8],
            styles: [
              "mat-card[_ngcontent-%COMP%]{display:block;margin-left:20%;margin-right:20%}",
            ],
          })),
          o
        );
      ...
      let br = (() => {
          ...
          constructor(e) {
            (this.breakpointObserver = e),
              ...
              (this.isHandset$ = this.breakpointObserver
                .observe(Et.u3.Handset)
                .pipe((0, _.U)((n) => n.matches)));
          }
          ngAfterViewInit() {
            this.windowWidth = window.innerWidth;
          }
        ...
        return (
          ...
          (o.ɵcmp = t.Xpm({
            ...
            template: function (e, n) {
              1 & e &&
                (t.TgZ(0, "mat-sidenav-container", 0)(1, "mat-sidenav-content"),
      ...
      let Zr = (() => {
          class o {
            ...
            updateStatus() {
              ...
              return (
                (0, Zt.D)([e, n]).subscribe(
                  ([{ setup: i, email: r, secret: l, setupToken: u }, f]) => {
                    if (
                      ((this.setupStatus = i),
            ...
            setup() {
              ...
              this.twoFactorAuthService
                .setup(
                  null ===
                    (e = this.twoFactorSetupForm.get("passwordControl")) ||
                    void 0 === e
                    ? void 0
                    : e.value,
                  null ===
                    (n = this.twoFactorSetupForm.get("initalTokenControl")) ||
                    void 0 === n
                    ? void 0
                    : n.value,
                  this.setupToken
                ...
                .subscribe(
                  ...
                  () => {
                    var i, r;
                    null ===
                      (i = this.twoFactorSetupForm.get("passwordControl")) ||
                      void 0 === i ||
                      i.markAsPristine(),
                      null ===
                        (r =
                          this.twoFactorSetupForm.get("initalTokenControl")) ||
                        void 0 === r ||
                        r.markAsPristine(),
                      (this.errored = !0);
                  }
            ...
            disable() {
              ...
              this.twoFactorAuthService
                .disable(
                  null ===
                    (e = this.twoFactorDisableForm.get("passwordControl")) ||
                    void 0 === e
                    ? void 0
                    : e.value
                )
                .subscribe(
                  ...
                  () => {
                    var n;
                    null ===
                      (n = this.twoFactorDisableForm.get("passwordControl")) ||
                      void 0 === n ||
                      n.markAsPristine(),
                      (this.errored = !0);
                  }
            ...
            (o.ɵcmp = t.Xpm({
              ...
              consts: [
                ...
                [
                  ...
                  "warn",
                  "aria-label",
                  "Button to remove the two-factor authentication",
                  3,
                  "disabled",
                ],
                [1, "material-icons"],
                ...
                [
                  ...
                  "",
                  "aria-label",
                  "Field to enter the initial token. This must have 6 digits.",
                  "minlength",
                  "6",
                  "maxlength",
                  "6",
                ...
                [
                  ...
                  "right",
                  "aria-label",
                  "The token to be entered from the authenticator must have 6 digits.",
                  3,
                  "matTooltip",
                ],
                ["align", "end"],
                [
                  ...
                  "primary",
                  "aria-label",
                  "Button to complete the two-factor configuration",
                  3,
                  "disabled",
                ],
              ],
              template: function (e, n) {
                1 & e &&
                  ...
                  t.qZA(),
                  t.YNc(4, xr, 18, 9, "div", 3),
                  t.YNc(5, Ar, 30, 20, "form", 4),
                  t.qZA()()),
                  2 & e &&
                    (t.xp6(4),
      ...
      function wr(o, a) {
        if (
          (1 & o && (t.TgZ(0, "div")(1, "p", 13), t._uU(2), t.qZA()()), 2 & o)
        ) {
          const e = t.oxw();
      ...
      function Ur(o, a) {
        if (
          (1 & o &&
            ...
            t._uU(14),
            t.qZA(),
            t.YNc(15, Sr, 2, 0, "mat-error", 20),
            t.YNc(16, yr, 2, 0, "mat-error", 20),
            t.qZA()()),
          2 & o)
        ) {
          const e = t.MAs(11),
          ...
          t.xp6(6),
            ...
            t.s9C(
              "placeholder",
              t.xi3(12, 6, "TYPE_THESE_LETTERS", t.DdM(9, Ir))
            ),
            t.Q6J("formControl", n.captchaControl),
            t.xp6(4),
            ...
            t.Q6J(
              "ngIf",
              n.captchaControl.invalid && n.captchaControl.errors.minlength
            );
        }
      }
      let kr = (() => {
          class o {
            ...
            needCaptcha() {
              const e = new Date(),
                n = localStorage.getItem("lstdtxprt")
                  ? new Date(
                      JSON.parse(String(localStorage.getItem("lstdtxprt")))
                    )
                  : new Date(0);
              e.getTime() - n.getTime() < 3e5 &&
                (this.getNewCaptcha(), (this.presenceOfCaptcha = !0));
            }
            getNewCaptcha() {
                ...
                this.dataSubjectService.dataExport(this.dataRequest).subscribe(
                  (e) => {
                    ...
                    (this.error = null),
                      ...
                      null === (n = window.open("", "_blank", "width=500")) ||
                        void 0 === n ||
                        n.document.write(this.userData),
                      (this.lastSuccessfulTry = new Date()),
                      localStorage.setItem(
                        "lstdtxprt",
                        JSON.stringify(this.lastSuccessfulTry)
                      ),
                      this.ngOnInit(),
                      this.resetForm();
                  },
            ...
            (o.ɵcmp = t.Xpm({
              ...
              template: function (e, n) {
                1 & e &&
                  ...
                  t.qZA(),
                  t.YNc(4, wr, 3, 1, "div", 3),
                  t.TgZ(5, "div", 4)(6, "mat-radio-group", 5)(
                    7,
                    "mat-label",
                    6
                  ),
                  ...
                  2 & e &&
                    ...
                    t.Q6J(
                      "disabled",
                      n.formatControl.invalid ||
                        (n.captchaControl.invalid && n.presenceOfCaptcha)
                    ),
                    t.xp6(3),
            ...
            (o.ɵcmp = t.Xpm({
              ...
              template: function (e, n) {
                1 & e &&
                  ...
                  t._UZ(7, "span", 3),
                  t.qZA()()),
                  2 & e && (t.xp6(7), t.Q6J("innerHTML", n.lastLoginIp, t.oJD));
              },
                  ...
                  .subscribe(
                    (e) => {
                      ...
                      !(
                        ...
                        n.name &&
                        (this.applicationName = e.application.name),
                        (this.privacyContactEmail =
                          null !== (i = null == e ? void 0 : e.application) &&
                          void 0 !== i &&
                          i.privacyContactEmail
                            ? e.application.privacyContactEmail
                            : `donotreply@${this._document.location.hostname}`);
                    },
                    (e) => console.log(e)
                  );
            }
            ...
            (o.ɵcmp = t.Xpm({
              ...
              consts: [
                ...
                [
                  ...
                  "aria-label",
                  "Link to the page where the privacy policy was created",
                ],
                [1, "divider"],
              ...
              template: function (e, n) {
                1 & e &&
                  (t.TgZ(0, "mat-card", 0)(1, "section", 1)(2, "h1", 2),
                  ...
                  t._uU(
                    41,
                    ' collect information how the Service is accessed and used ("Usage Data"). This Usage Data may include information such as your computer\'s Internet Protocol address (e.g. IP address), browser type, browser version, the pages of our Service that you visit, the time and date of your visit, the time spent on those pages, unique device identifiers and other diagnostic data.'
                  ),
                  t.qZA(),
                  t.TgZ(42, "h4"),
                  ...
                  t._uU(
                    62,
                    " \xa0We use Session Cookies to operate our Service."
                  ),
                  t.qZA(),
                  ...
                  t._uU(
                    66,
                    "\xa0We use Preference Cookies to remember your preferences and various settings. "
                  ),
                  t.qZA(),
                  ...
                  t._uU(
                    70,
                    "\xa0We use Security Cookies for security purposes."
                  ),
                  t.qZA()(),
                  t.TgZ(71, "h3"),
                  ...
                  t._uU(
                    103,
                    " to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information."
                  ),
                  t.qZA(),
      ...
      function Lr(o, a) {
        1 & o &&
          (t.TgZ(0, "mat-error", 2), t._uU(1, " MANDATORY_COUNTRY "), t.qZA());
      }
      function Nr(o, a) {
        1 & o &&
          (t.TgZ(0, "mat-error", 2), t._uU(1, " MANDATORY_NAME "), t.qZA());
      }
      function Er(o, a) {
        1 & o &&
          (t.TgZ(0, "mat-error", 2), t._uU(1, " MANDATORY_NUMBER "), t.qZA());
      }
      const qr = function () {
      ...
      function Mr(o, a) {
        1 & o &&
          (t.TgZ(0, "mat-error", 18),
          t._uU(1, "INVALID_MOBILE_NUMBER "),
          t.qZA()),
          2 & o && t.Q6J("translateParams", t.DdM(1, qr));
      }
      function Dr(o, a) {
        1 & o &&
          (t.TgZ(0, "mat-error", 2), t._uU(1, " MANDATORY_ZIP "), t.qZA());
      }
      function Fr(o, a) {
        1 & o &&
          (t.TgZ(0, "mat-error", 2), t._uU(1, "MANDATORY_ADDRESS"), t.qZA());
      }
      function Rr(o, a) {
        1 & o &&
          (t.TgZ(0, "mat-error", 2), t._uU(1, " MANDATORY_CITY "), t.qZA());
      }
      const Yr = function () {
        return { length: "160" };
      };
      let ve = (() => {
          class o {
            constructor(e, n, i, r, l, u, f) {
              (this.location = e),
                ...
                (this.numberControl = new s.p4("", [
                  s.kI.required,
                  s.kI.min(1111111),
                  s.kI.max(9999999999),
                ])),
                (this.pinControl = new s.p4("", [
                  s.kI.required,
                  s.kI.maxLength(8),
                ])),
                (this.addressControl = new s.p4("", [
                  s.kI.required,
                  s.kI.maxLength(160),
                ])),
            ...
            save() {
              (this.address.country = this.countryControl.value),
                ...
                "edit" === this.mode
                  ? this.addressService
                      .put(this.addressId, this.address)
                      .subscribe(
                        (e) => {
                          (this.address = {}),
                            this.ngOnInit(),
                            ...
                            this.translate
                              .get("ADDRESS_UPDATED", { city: e.city })
                              .subscribe(
                                (n) => {
                                  this.snackBarHelperService.open(
                                    n,
          ...
          return (
            ...
            (o.ɵcmp = t.Xpm({
              ...
              template: function (e, n) {
                if (
                  (1 & e &&
                    ...
                    t.qZA(),
                    t.TgZ(4, "div", 3)(5, "mat-form-field", 4)(
                      6,
                      "mat-label",
                      2
                    ),
                    ...
                    t._UZ(20, "input", 7),
                    t.ALo(21, "translate"),
                    t.YNc(22, Er, 2, 0, "mat-error", 6),
                    t.YNc(23, Mr, 2, 2, "mat-error", 8),
                    t.qZA(),
                  ...
                  const i = t.MAs(28),
                    r = t.MAs(37);
                  t.xp6(8),
                    t.Q6J("formControl", n.countryControl)(
                      "placeholder",
                      t.lcZ(9, 27, "MANDATORY_COUNTRY")
                    ),
                    t.xp6(2),
                    t.Q6J(
                      "ngIf",
                      n.countryControl.invalid &&
                        n.countryControl.errors.required
                    ),
                    t.xp6(4),
                    t.Q6J("formControl", n.nameControl)(
                      "placeholder",
                      t.lcZ(15, 29, "MANDATORY_NAME")
                    ),
                    t.xp6(2),
                    t.Q6J(
                      "ngIf",
                      n.nameControl.invalid && n.nameControl.errors.required
                    ),
                    t.xp6(4),
                    t.Q6J("formControl", n.numberControl)(
                      "placeholder",
                      t.lcZ(21, 31, "MANDATORY_NUMBER")
                    ),
                    t.xp6(2),
                    t.Q6J(
                      "ngIf",
                      n.numberControl.invalid && n.numberControl.errors.required
                    ),
                    t.xp6(1),
                    t.Q6J(
                      "ngIf",
                      n.numberControl.invalid &&
                        (n.numberControl.errors.min ||
                          n.numberControl.errors.max)
                    ),
                    t.xp6(4),
                    t.Q6J("formControl", n.pinControl)(
                      "placeholder",
                      t.lcZ(29, 33, "MANDATORY_ZIP")
                    ),
                    t.xp6(4),
                    t.hij(
                      "",
                    ...
                    t.Q6J(
                      "ngIf",
                      n.pinControl.invalid && n.pinControl.errors.required
                    ),
                    t.xp6(4),
                    t.Q6J("formControl", n.addressControl)(
                      "placeholder",
                      t.lcZ(38, 35, "MANDATORY_ADDRESS")
                    ),
                    t.xp6(6),
                    t.Oqu(t.xi3(43, 37, "MAX_TEXTAREA_LENGTH", t.DdM(48, Yr))),
                    t.xp6(3),
                    t.hij(
                      "",
                      (null == r.value ? null : r.value.length) || 0,
                    ...
                    t.Q6J(
                      "ngIf",
                      n.addressControl.invalid &&
                        n.addressControl.errors.required
                    ),
                    t.xp6(4),
                    t.Q6J("formControl", n.cityControl)(
                      "placeholder",
                      t.lcZ(51, 40, "MANDATORY_CITY")
                    ),
                    t.xp6(2),
                    t.Q6J(
                      "ngIf",
                      n.cityControl.invalid && n.cityControl.errors.required
                    ),
                    t.xp6(4),
                    t.Q6J("formControl", n.stateControl)(
                      "placeholder",
                      t.lcZ(57, 42, "STATE_PLACEHOLDER")
                    ),
                    t.xp6(6),
                    ...
                    t.Q6J(
                      "disabled",
                      n.countryControl.invalid ||
                        n.nameControl.invalid ||
                        n.numberControl.invalid ||
                        n.pinControl.invalid ||
                        n.addressControl.invalid ||
                        n.cityControl.invalid
                    ),
                    t.xp6(3),
              ...
              styles: [
                "mat-card[_ngcontent-%COMP%]{height:auto;min-width:320px;width:30%}#submitButton[_ngcontent-%COMP%]{float:right}.form-container[_ngcontent-%COMP%]{display:flex;flex-direction:column;position:relative}.btn-return[_ngcontent-%COMP%]{float:left}input[_ngcontent-%COMP%]::-webkit-outer-spin-button, input[_ngcontent-%COMP%]::-webkit-inner-spin-button{-webkit-appearance:none;-moz-appearance:none;margin:0}",
              ],
            })),
            o
          );
        ...
        Br = (() => {
          ...
          return (
            ...
            (o.ɵcmp = t.Xpm({
              ...
              template: function (e, n) {
                1 & e &&
                  (t.TgZ(0, "div", 0), t._UZ(1, "app-address", 1), t.qZA()),
                  2 & e &&
                    (t.xp6(1), t.Q6J("showNextButton", n.showNextButton));
              },
              dependencies: [Ot],
              styles: [
                ".btn-pay[_ngcontent-%COMP%]{display:block;width:100%}.mat-raised-button[_ngcontent-%COMP%]{margin-right:3px;margin-top:3px}#card[_ngcontent-%COMP%]{display:block;margin-left:20%;margin-right:20%}",
              ],
            })),
            o
          );
      ...
      let Mt = (() => {
        ...
        Dt = (() => {
          class o {
            ...
            put(e) {
              return this.http.put(this.host, e).pipe(
                (0, _.U)((n) => n.data),
                (0, m.K)((n) => {
                  throw n;
                })
      ...
      function os(o, a) {
        if (
          (1 & o &&
            (t.TgZ(0, "div")(1, "mat-table", 17),
            t.ynx(2, 18),
            t.YNc(3, Qr, 1, 0, "mat-header-cell", 19),
            t.YNc(4, Hr, 2, 0, "mat-cell", 20),
            t.BQk(),
            t.ynx(5, 21),
            t.YNc(6, Gr, 1, 0, "mat-header-cell", 22),
            t.YNc(7, jr, 2, 1, "mat-cell", 23),
            t.BQk(),
            t.ynx(8, 24),
            t.YNc(9, zr, 1, 0, "mat-header-cell", 25),
            t.YNc(10, Kr, 2, 1, "mat-cell", 26),
            t.BQk(),
            t.ynx(11, 27),
            t.YNc(12, Wr, 1, 0, "mat-header-cell", 28),
            t.YNc(13, $r, 2, 2, "mat-cell", 29),
            t.BQk(),
            t.ynx(14, 30),
            t.YNc(15, Vr, 1, 0, "mat-header-cell", 19),
            t.YNc(16, Xr, 3, 0, "mat-cell", 20),
            t.BQk(),
            t.YNc(17, ts, 1, 0, "mat-header-row", 31),
            t.YNc(18, es, 1, 0, "mat-row", 32),
            t.qZA()()),
          2 & o)
        ) {
          const e = t.oxw();
      ...
      function ns(o, a) {
        1 & o &&
          (t.TgZ(0, "mat-error", 5), t._uU(1, " MANDATORY_NAME "), t.qZA());
      }
      function as(o, a) {
        1 & o &&
          (t.TgZ(0, "mat-error", 5),
      ...
      function is(o, a) {
        1 & o &&
          (t.TgZ(0, "mat-error", 5), t._uU(1, " VALID_CARD_NUMBER "), t.qZA());
      }
      function rs(o, a) {
        ...
        class o {
          ...
          ngOnInit() {
            (this.monthRange = Array.from(Array(12).keys()).map((e) => e + 1)),
              (this.yearRange = Array.from(Array(20).keys()).map(
                (e) => e + 2080
              )),
              this.allowDelete
            ...
            (this.card.fullName = this.nameControl.value),
              ...
              this.paymentService.save(this.card).subscribe(
                (e) => {
                  (this.error = null),
                    this.translate
                      .get("CREDIT_CARD_SAVED", {
                        cardnumber: String(e.cardNum).substring(
                          String(e.cardNum).length - 4
                        ),
                      })
                      .subscribe(
                        (n) => {
            ...
            template: function (e, n) {
              if (
                (1 & e &&
                  ...
                  t.ALo(3, "translate"),
                  t.qZA(),
                  t.YNc(4, os, 19, 3, "div", 1),
                  t.TgZ(5, "div")(6, "mat-expansion-panel", 2)(
                    7,
                  ...
                  t._uU(26),
                  t.qZA(),
                  t.YNc(27, as, 2, 0, "mat-error", 7),
                  t.YNc(28, is, 2, 0, "mat-error", 7),
                  t.qZA(),
                  t.TgZ(29, "mat-form-field", 11)(30, "mat-label", 5),
                  t._uU(31, "LABEL_EXPIRY_MONTH"),
                  t.qZA(),
                  t.TgZ(32, "select", 12),
                  t.YNc(33, rs, 2, 2, "option", 13),
                  t.qZA(),
                  t.YNc(34, ss, 2, 0, "mat-error", 7),
                  t.qZA(),
                  t.TgZ(35, "mat-form-field", 14)(36, "mat-label", 5),
                  t._uU(37, "LABEL_EXPIRY_YEAR"),
                  t.qZA(),
                  t.TgZ(38, "select", 12),
                  t.YNc(39, ls, 2, 2, "option", 13),
                  t.qZA(),
                  t.YNc(40, cs, 2, 0, "mat-error", 7),
                  t.qZA()(),
                  t.TgZ(41, "button", 15),
                  t.NdJ("click", function () {
                    return n.save();
                ...
                t.xp6(2),
                  ...
                  t.Q6J(
                    "ngIf",
                    n.numberControl.invalid &&
                      (n.numberControl.errors.min || n.numberControl.errors.max)
                  ),
                  t.xp6(4),
                  ...
                  t.Q6J(
                    "ngIf",
                    n.monthControl.invalid && n.monthControl.errors.required
                  ),
                  t.xp6(4),
                  ...
                  t.Q6J(
                    "ngIf",
                    n.yearControl.invalid && n.yearControl.errors.required
                  ),
                  t.xp6(1),
                  t.Q6J(
                    "disabled",
                    n.nameControl.invalid ||
                      n.numberControl.invalid ||
                      n.monthControl.invalid ||
                      n.yearControl.invalid
                  ),
                  t.xp6(3),
      ...
      function us(o, a) {
        ...
        if (2 & o) {
          ...
          t.xp6(10),
            ...
            t.AsE(
              " ",
              t.lcZ(15, 4, "LABEL_PAY"),
              " ",
              null == e.totalPrice ? null : e.totalPrice.toFixed(2),
              "\xa4 "
            );
        }
      }
      ...
      function ms(o, a) {
        1 & o &&
          (t.TgZ(0, "mat-error"), t._uU(1), t.ALo(2, "translate"), t.qZA()),
          2 & o && (t.xp6(1), t.hij(" ", t.lcZ(2, 1, "COUPON_CODE_HINT"), " "));
      }
      const hs = function (o, a) {
        return { twitter: o, facebook: a };
      };
      function _s(o, a) {
        if (1 & o) {
          const e = t.EpF();
          t.TgZ(0, "mat-expansion-panel", 20)(
            ...
            t.ALo(7, "translate"),
            t.qZA()(),
            t.YNc(8, ds, 2, 1, "div", 22),
            t.YNc(9, ps, 2, 1, "div", 23),
          ...
          t.Q6J("expanded", n.couponPanelExpanded),
            ...
            t.Q6J(
              ...
              t.xi3(
                14,
                16,
                "FOLLOW_FOR_MONTHLY_COUPONS",
                t.WLB(23, hs, n.twitterUrl, n.facebookUrl)
              ),
              t.oJD
            ),
            t.xp6(2),
            ...
            t.Q6J(
              "ngIf",
              n.couponControl.invalid &&
                (n.couponControl.errors.minlength ||
                  n.couponControl.errors.maxlength)
            ),
            t.xp6(1),
      ...
      function gs(o, a) {
        1 & o &&
          (t.TgZ(0, "span", 54), t._uU(1, "THANKS_FOR_SUPPORT"), t.qZA()),
          2 & o && t.Q6J("translateParams", t.DdM(1, be));
      }
      const xe = function (o) {
        return { appname: o };
      };
      ...
      function As(o, a) {
        if (
          (1 & o &&
            (t.TgZ(0, "mat-expansion-panel", 33)(
              1,
              "mat-expansion-panel-header",
              21
            )(2, "mat-panel-title"),
            ...
            t.TgZ(10, "small"),
            t._uU(11, " ("),
            t.YNc(12, gs, 2, 2, "span", 37),
            t.YNc(13, fs, 2, 3, "span", 37),
            t._UZ(14, "i", 38),
            t._uU(15, ") "),
            t.qZA(),
            ...
            t.ALo(21, "translate"),
            t.qZA()(),
            t.YNc(22, Cs, 3, 0, "button", 43),
            t.YNc(23, vs, 4, 0, "button", 43),
            t.YNc(24, Ts, 3, 0, "button", 43),
            t.qZA()(),
            t._UZ(25, "span", 44),
            ...
            t.TgZ(30, "small"),
            t._uU(31, " ("),
            t.YNc(32, bs, 2, 2, "span", 37),
            t.YNc(33, xs, 2, 3, "span", 37),
            t._UZ(34, "i", 46),
            t._uU(35, ") "),
            t.qZA(),
          ...
          class o {
            constructor(e, n, i, r, l, u, f, b, S, w, nt, tt, et) {
              (this.location = e),
                ...
                (this.campaigns = {
                  WMNSDY2019: { validOn: 15519996e5, discount: 75 },
            ...
            ngOnInit() {
              this.initTotal(),
                ...
                (this.couponPanelExpanded =
                  !!localStorage.getItem("couponPanelExpanded") &&
                  JSON.parse(localStorage.getItem("couponPanelExpanded"))),
                (this.paymentPanelExpanded =
                  !!localStorage.getItem("paymentPanelExpanded") &&
            ...
            initTotal() {
              this.activatedRoute.paramMap.subscribe(
                (e) => {
                  if (((this.mode = e.get("entity")), "wallet" === this.mode))
                    this.totalPrice = parseFloat(
                      sessionStorage.getItem("walletTotal")
                    );
                    ...
                    const n = parseFloat(sessionStorage.getItem("itemTotal")),
                      i = sessionStorage.getItem("couponDiscount")
                        ? (parseFloat(
                    ...
                    this.deliveryService
                      .getById(sessionStorage.getItem("deliveryMethodId"))
                      .subscribe((r) => {
            ...
            applyCoupon() {
              ...
              n
                ...
                : this.basketService
                    .applyCoupon(
                      Number(sessionStorage.getItem("bid")),
                      encodeURIComponent(this.couponControl.value)
                    )
                    .subscribe(
                      (i) => {
            ...
            showConfirmation(e) {
              this.resetCouponForm(),
                ...
                this.translate
                  .get("DISCOUNT_APPLIED", { discount: e })
                  .subscribe(
                    (n) => {
            ...
            choosePayment() {
              var e = this;
              if (
                (sessionStorage.removeItem("itemTotal"), "wallet" === this.mode)
              )
                this.walletService
                  .put({ balance: this.totalPrice, paymentId: this.paymentId })
                  .subscribe(
                    () => {
                ...
                this.userService
                  .upgradeToDeluxe(this.paymentMode, this.paymentId)
                  .subscribe(
                    (n) => {
                      localStorage.setItem("token", n.token),
                ...
                if ("wallet" === this.paymentMode) {
                  if (this.walletBalance < this.totalPrice)
                    return void this.snackBarHelperService.open(
            ...
            (o.ɵcmp = t.Xpm({
              ...
              template: function (e, n) {
                1 & e &&
                  ...
                  t.qZA(),
                  t._UZ(3, "mat-divider"),
                  t.YNc(4, us, 16, 6, "div", 2),
                  t._UZ(5, "mat-divider"),
                  t.YNc(6, _s, 26, 26, "mat-expansion-panel", 3),
                  t._UZ(7, "mat-divider"),
                  t.YNc(8, As, 53, 14, "mat-expansion-panel", 4),
                  t._UZ(9, "mat-divider"),
                  ...
                  t.qZA()(),
                  t.TgZ(21, "p", 9),
                  t.YNc(22, Zs, 2, 0, "span", 10),
                  t.YNc(23, ws, 2, 0, "span", 10),
                  t.qZA()()()()),
                  2 & e &&
                    (t.xp6(2),
                    t.Q6J("allowDelete", !1),
                    ...
                    t.Q6J(
                      "disabled",
                      void 0 === n.paymentId && "wallet" !== n.paymentMode
                    ),
                    t.xp6(6),
            ...
            (o.ɵcmp = t.Xpm({
              ...
              template: function (e, n) {
                1 & e &&
                  ...
                  t.qZA()),
                  2 & e && (t.xp6(1), t.Q6J("allowDelete", !0));
              },
      ...
      function Ms(o, a) {
        if (
          (1 & o &&
            (t.TgZ(0, "mat-cell", 37),
            t.YNc(1, Es, 2, 0, "div", 38),
            t.YNc(2, qs, 2, 0, "div", 39),
            t.qZA()),
          2 & o)
        ) {
          const e = a.$implicit;
      ...
      function Ys(o, a) {
        if (
          (1 & o &&
            (t.TgZ(0, "mat-cell", 35),
            t.YNc(1, Fs, 4, 3, "button", 42),
            t.YNc(2, Rs, 4, 3, "button", 42),
            t.qZA()),
          2 & o)
        ) {
          const e = a.$implicit;
      ...
      let Vs = (() => {
        class o {
          ...
          modifyQuantity(e, n) {
            this.quantityService.put(e, { quantity: n < 0 ? 0 : n }).subscribe(
              (i) => {
                const r = this.tableData.find((l) => l.id === i.ProductId);
                this.snackBarHelperService.open(
                  `Quantity for ${r.name} has been updated.`,
                  "confirmBar"
                ),
                  this.loadQuantity();
              },
          ...
          modifyPrice(e, n) {
            this.productService.put(e, { price: n < 0 ? 0 : n }).subscribe(
              (i) => {
                this.snackBarHelperService.open(
                  `Price for ${i.name} has been updated.`,
                  "confirmBar"
                ),
                  this.loadProducts();
              },
          ...
          changeDeliveryStatus(e, n) {
            this.orderHistoryService
              .toggleDeliveryStatus(n, { deliveryStatus: e })
              .subscribe(
                () => {
                  this.loadOrders();
                },
          ...
          (o.ɵcmp = t.Xpm({
            ...
            template: function (e, n) {
              1 & e &&
                ...
                t.TgZ(9, "mat-table", 6),
                t.ynx(10, 7),
                t.YNc(11, ks, 1, 0, "mat-header-cell", 8),
                t.YNc(12, Os, 2, 1, "mat-cell", 9),
                t.BQk(),
                t.ynx(13, 10),
                t.YNc(14, Ps, 1, 0, "mat-header-cell", 11),
                t.YNc(15, Ls, 2, 1, "mat-cell", 12),
                t.BQk(),
                t.ynx(16, 13),
                t.YNc(17, Ns, 1, 0, "mat-header-cell", 14),
                t.YNc(18, Ms, 3, 2, "mat-cell", 15),
                t.BQk(),
                t.ynx(19, 16),
                t.YNc(20, Ds, 1, 0, "mat-header-cell", 17),
                t.YNc(21, Ys, 3, 2, "mat-cell", 12),
                t.BQk(),
                t.YNc(22, Bs, 1, 0, "mat-header-row", 18),
                t.YNc(23, Js, 1, 0, "mat-row", 19),
                t.qZA(),
                t._UZ(24, "mat-paginator", 20, 21),
                t.qZA()(),
                t.TgZ(26, "div", 22)(27, "div", 23)(28, "div", 5)(
                  29,
                  "span",
                  1
                ),
                ...
                t.ynx(32, 24),
                t.YNc(33, Qs, 1, 0, "mat-header-cell", 25),
                t.YNc(34, Hs, 2, 1, "mat-cell", 26),
                t.BQk(),
                t.ynx(35, 10),
                t.YNc(36, Gs, 1, 0, "mat-header-cell", 27),
                t.YNc(37, js, 6, 1, "mat-cell", 28),
                t.BQk(),
                t.ynx(38, 29),
                t.YNc(39, zs, 1, 0, "mat-header-cell", 30),
                t.YNc(40, Ks, 6, 1, "mat-cell", 28),
                t.BQk(),
                t.YNc(41, Ws, 1, 0, "mat-header-row", 18),
                t.YNc(42, $s, 1, 0, "mat-row", 19),
                t.qZA(),
      ...
      function el(o, a) {
        if (
          ...
          t.xp6(1),
            t.Q6J(
              "ngIf",
              "?" !== e.orderDetails.eta && void 0 !== e.orderDetails.eta
            ),
            t.xp6(5),
            ...
            t.HOy(
              "",
              null == e.address ? null : e.address.streetAddress,
              ", ",
              null == e.address ? null : e.address.city,
              ", ",
              null == e.address ? null : e.address.state,
              ", ",
              null == e.address ? null : e.address.zipCode,
              ""
            ),
            t.xp6(2),
      ...
      function ol(o, a) {
        1 & o &&
          (t.TgZ(0, "mat-header-cell", 4), t._uU(1, "LABEL_PRODUCT"), t.qZA());
      }
      function nl(o, a) {
        if ((1 & o && (t.TgZ(0, "mat-cell"), t._uU(1), t.qZA()), 2 & o)) {
          const e = a.$implicit;
      ...
      function il(o, a) {
        1 & o &&
          (t.TgZ(0, "mat-header-cell", 4), t._uU(1, "LABEL_PRICE"), t.qZA());
      }
      function rl(o, a) {
        if ((1 & o && (t.TgZ(0, "mat-cell"), t._uU(1), t.qZA()), 2 & o)) {
          const e = a.$implicit;
      ...
      function ll(o, a) {
        1 & o &&
          (t.TgZ(0, "mat-header-cell", 4), t._uU(1, "LABEL_QUANTITY"), t.qZA());
      }
      function cl(o, a) {
        if (
          (1 & o && (t.TgZ(0, "mat-cell")(1, "span"), t._uU(2), t.qZA()()),
          2 & o)
        ) {
          const e = a.$implicit;
      ...
      function ul(o, a) {
        1 & o &&
          (t.TgZ(0, "mat-footer-cell")(1, "table", 31)(2, "tr", 32)(3, "td", 4),
          t._uU(4, "ITEMS"),
          t.qZA()(),
      ...
      function ml(o, a) {
        if (
          (1 & o &&
            (t.TgZ(0, "mat-footer-cell")(1, "table", 34)(2, "tr", 32)(3, "td"),
            t._uU(4),
            t.qZA()(),
            t.TgZ(5, "tr", 32)(6, "td"),
            t._uU(7),
          ...
          t.xp6(4),
            t.hij(
              "",
              null == e.orderDetails.itemTotal
                ? null
                : e.orderDetails.itemTotal.toFixed(2),
              "\xa4"
            ),
            t.xp6(3),
            ...
            t.hij(
              ...
              null == e.orderDetails.totalPrice
                ? null
                : e.orderDetails.totalPrice.toFixed(2),
              "\xa4"
            );
        }
      }
              ...
              (e) => {
                (this.orderId = e.get("id")),
                  this.trackOrderService.find(this.orderId).subscribe(
                    (n) => {
                      (this.promotionalDiscount = n.data[0].promotionalAmount
                        ? parseFloat(n.data[0].promotionalAmount)
                        : 0),
                        (this.deliveryPrice = n.data[0].deliveryPrice
                      ...
                      (this.tweetText = this.truncateTweet(this.tweetText)),
                        this.configurationService
                          ...
                          .subscribe(
                            (i) => {
                              var r;
                              null !==
                                (r = null == i ? void 0 : i.application) &&
                                void 0 !== r &&
                                r.social &&
                                ((this.tweetText += "%0afrom "),
                                (this.tweetText += i.application.social
                                  .twitterUrl
                                  ? i.application.social.twitterUrl.replace(
                                      "https://twitter.com/",
                                      "@"
                                    )
                                  : i.application.name));
                        ...
                        this.addressService
                          .getById(this.orderDetails.addressId)
                          .subscribe(
                            (i) => {
                              this.address = i;
                            },
          ...
          (o.ɵcmp = t.Xpm({
            ...
            template: function (e, n) {
              1 & e &&
                ...
                t.ynx(28, 17),
                t.YNc(29, ol, 2, 0, "mat-header-cell", 18),
                t.YNc(30, nl, 2, 1, "mat-cell", 19),
                t.YNc(31, al, 1, 0, "mat-footer-cell", 20),
                t.BQk(),
                t.ynx(32, 21),
                t.YNc(33, il, 2, 0, "mat-header-cell", 18),
                t.YNc(34, rl, 2, 1, "mat-cell", 19),
                t.YNc(35, sl, 1, 0, "mat-footer-cell", 20),
                t.BQk(),
                t.ynx(36, 22),
                t.YNc(37, ll, 2, 0, "mat-header-cell", 18),
                t.YNc(38, cl, 3, 1, "mat-cell", 19),
                t.YNc(39, ul, 14, 0, "mat-footer-cell", 20),
                t.BQk(),
                t.ynx(40, 23),
                t.YNc(41, dl, 2, 0, "mat-header-cell", 18),
                t.YNc(42, pl, 2, 1, "mat-cell", 24),
                t.YNc(43, ml, 14, 4, "mat-footer-cell", 20),
                t.BQk(),
                t.YNc(44, hl, 1, 0, "mat-header-row", 25),
                t.YNc(45, _l, 1, 0, "mat-row", 26),
                t.YNc(46, gl, 1, 0, "mat-footer-row", 27),
                t.qZA()(),
                ...
                2 & e &&
                  (t.xp6(9),
                  t.Q6J("queryParams", t.VKq(14, fl, n.orderId)),
                  t.xp6(4),
                  ...
                  t.s9C(
                    "matTooltip",
                    t.lcZ(24, 12, "PRINT_ORDER_CONFIRMATION")
                  ),
                  t.xp6(4),
                  t.Q6J("dataSource", n.dataSource),
                  t.xp6(17),
            ...
            styles: [
              ".heading[_ngcontent-%COMP%]{background:rgba(0,0,0,.2);font-size:x-large}.heading-text[_ngcontent-%COMP%]{justify-content:center;padding:12px 20px}.mat-own-card[_ngcontent-%COMP%]{display:block;margin-left:20%;margin-right:20%}mat-cell[_ngcontent-%COMP%], mat-footer-cell[_ngcontent-%COMP%], mat-header-cell[_ngcontent-%COMP%]{padding-left:10px;padding-right:10px}.price-align[_ngcontent-%COMP%]{text-align:right}.tweet-logo[_ngcontent-%COMP%]{height:24px}",
            ],
          })),
          o
        );
      ...
      function Tl(o, a) {
        if (
          (1 & o &&
            (t.TgZ(0, "mat-card", 20)(1, "div")(2, "div")(3, "b", 14),
          ...
          t.xp6(8),
            t.hij(
              " ",
              null == e.paymentMethod ? null : e.paymentMethod.cardNum,
              ""
            ),
            t.xp6(4),
            t.hij(
              " ",
              null == e.paymentMethod ? null : e.paymentMethod.fullName,
              ""
            );
        }
      }
      ...
      function xl(o, a) {
        if (
          (1 & o &&
            (t.TgZ(0, "div", 16)(1, "mat-card", 17)(2, "div")(3, "div")(
              4,
              "b",
              14
            ),
            ...
            t._uU(15),
            t.qZA()()(),
            t.YNc(16, Tl, 13, 2, "mat-card", 18),
            t.YNc(17, bl, 8, 0, "ng-template", null, 19, t.W1O),
            t.qZA()),
          2 & o)
        ) {
          const e = t.MAs(18),
          ...
          t.xp6(7),
            ...
            t.HOy(
              "",
              null == n.address ? null : n.address.streetAddress,
              ", ",
              null == n.address ? null : n.address.city,
              ", ",
              null == n.address ? null : n.address.state,
              ", ",
              null == n.address ? null : n.address.zipCode,
              ""
            ),
            t.xp6(2),
      ...
      let Zl = (() => {
        class o {
          ...
          ngOnInit() {
            this.deliveryService
              ...
              this.addressService
                .getById(sessionStorage.getItem("addressId"))
                .subscribe(
                  (e) => {
                    this.address = e;
                  },
              ...
              "wallet" !== sessionStorage.getItem("paymentId")
                ? this.paymentService
                    .getById(sessionStorage.getItem("paymentId"))
                    .subscribe(
                      (e) => {
                        (e.cardNum = String(e.cardNum).substring(
                          String(e.cardNum).length - 4
                        )),
          ...
          getMessage(e) {
            (this.itemTotal = e[0]),
              (this.promotionalDiscount = sessionStorage.getItem(
                "couponDiscount"
              )
          ...
          placeOrder() {
            ...
            this.basketService
              .checkout(
                Number(sessionStorage.getItem("bid")),
                btoa(sessionStorage.getItem("couponDetails")),
                n
              )
              .subscribe(
                (i) => {
        ...
        return (
          ...
          (o.ɵcmp = t.Xpm({
            ...
            template: function (e, n) {
              1 & e &&
                (t.TgZ(0, "mat-card", 0)(1, "div", 1),
                t.YNc(2, xl, 19, 9, "div", 2),
                ...
                2 & e &&
                  ...
                  t.hij(
                    "",
                    null == n.itemTotal ? null : n.itemTotal.toFixed(2),
                    "\xa4"
                  ),
                  t.xp6(5),
      ...
      function wl(o, a) {
        1 & o &&
          (t.TgZ(0, "mat-error", 1), t._uU(1, " MANDATORY_AMOUNT "), t.qZA());
      }
      function Sl(o, a) {
        1 & o &&
          (t.TgZ(0, "mat-error", 1), t._uU(1, " AMOUNT_LIMIT "), t.qZA());
      }
      let yl = (() => {
        class o {
          constructor(e, n, i) {
          ...
          (o.ɵcmp = t.Xpm({
            ...
            template: function (e, n) {
              1 & e &&
                ...
                t.qZA(),
                t._UZ(17, "input", 4),
                t.YNc(18, wl, 2, 0, "mat-error", 5),
                t.YNc(19, Sl, 2, 0, "mat-error", 5),
                t.qZA(),
                t.TgZ(20, "button", 6),
                t.NdJ("click", function () {
                  return n.continue();
                ...
                2 & e &&
                  ...
                  t.Q6J(
                    "ngIf",
                    n.balanceControl.invalid && n.balanceControl.errors.required
                  ),
                  t.xp6(1),
                  t.Q6J(
                    "ngIf",
                    n.balanceControl.invalid &&
                      (n.balanceControl.errors.min ||
                        n.balanceControl.errors.max)
                  ),
                  t.xp6(1),
      ...
      function kl(o, a) {
        1 & o &&
          (t.TgZ(0, "mat-header-cell", 34), t._uU(1, "LABEL_PRODUCT"), t.qZA());
      }
      function Ol(o, a) {
        if ((1 & o && (t.TgZ(0, "mat-cell", 35), t._uU(1), t.qZA()), 2 & o)) {
          const e = a.$implicit;
      ...
      function Pl(o, a) {
        1 & o &&
          (t.TgZ(0, "mat-header-cell", 36), t._uU(1, "LABEL_PRICE"), t.qZA());
      }
      function Ll(o, a) {
        if ((1 & o && (t.TgZ(0, "mat-cell", 37), t._uU(1), t.qZA()), 2 & o)) {
          const e = a.$implicit;
      ...
      function Nl(o, a) {
        1 & o &&
          (t.TgZ(0, "mat-header-cell", 36),
          t._uU(1, "LABEL_QUANTITY"),
          t.qZA());
      }
      function El(o, a) {
        if (
          (1 & o && (t.TgZ(0, "mat-cell", 37)(1, "span"), t._uU(2), t.qZA()()),
          2 & o)
        ) {
          const e = a.$implicit;
          t.xp6(2), t.Oqu(e.quantity);
      ...
      function Bl(o, a) {
        if (1 & o) {
          const e = t.EpF();
          t.TgZ(0, "div")(1, "div", 6)(2, "div", 7)(3, "div", 8)(4, "div", 9)(
            5,
            "div",
            10
          ),
            ...
            t.qZA()(),
            t.TgZ(19, "div", 12),
            t.YNc(20, Il, 2, 0, "div", 13),
            t.YNc(21, Ul, 2, 0, "div", 14),
            t.qZA(),
            ...
            t.ynx(34, 20),
            t.YNc(35, kl, 2, 0, "mat-header-cell", 21),
            t.YNc(36, Ol, 2, 1, "mat-cell", 22),
            t.BQk(),
            t.ynx(37, 23),
            t.YNc(38, Pl, 2, 0, "mat-header-cell", 24),
            t.YNc(39, Ll, 2, 1, "mat-cell", 25),
            t.BQk(),
            t.ynx(40, 26),
            t.YNc(41, Nl, 2, 0, "mat-header-cell", 24),
            t.YNc(42, El, 3, 1, "mat-cell", 25),
            t.BQk(),
            t.ynx(43, 27),
            t.YNc(44, ql, 2, 0, "mat-header-cell", 24),
            t.YNc(45, Ml, 2, 1, "mat-cell", 28),
            t.BQk(),
            t.ynx(46, 29),
            t.YNc(47, Dl, 1, 0, "mat-header-cell", 24),
            t.YNc(48, Fl, 5, 3, "mat-cell", 25),
            t.BQk(),
            t.YNc(49, Rl, 1, 0, "mat-header-row", 30),
            t.YNc(50, Yl, 1, 0, "mat-row", 31),
            t.qZA()()();
        }
        if (2 & o) {
          const e = a.$implicit,
      ...
      function Jl(o, a) {
        if (
          (1 & o &&
            (t.TgZ(0, "div", 4), t.YNc(1, Bl, 51, 14, "div", 5), t.qZA()),
          2 & o)
        ) {
          const e = t.oxw();
        ...
        return (
          ...
          (o.ɵcmp = t.Xpm({
            ...
            template: function (e, n) {
              if (
                (1 & e &&
                  (t.TgZ(0, "mat-card", 0)(1, "div", 1)(2, "mat-card-title"),
                  t._uU(3),
                  t.ALo(4, "translate"),
                  t.qZA(),
                  t.YNc(5, Jl, 2, 1, "div", 2),
                  t.YNc(6, Ql, 8, 0, "ng-template", null, 3, t.W1O),
                  t.qZA()()),
                2 & e)
              ) {
                const i = t.MAs(7);
      ...
      function $l(o, a) {
        if (
          (1 & o &&
            (t.TgZ(0, "mat-cell", 26), t._UZ(1, "i", 27), t._uU(2), t.qZA()),
          2 & o)
        ) {
          const e = a.$implicit;
          t.xp6(1),
      ...
      let ac = (() => {
        class o {
          ...
          chooseDeliveryMethod() {
            ...
            sessionStorage.setItem(
              "deliveryMethodId",
              this.deliveryMethodId.toString()
            ),
              this.ngZone.run(
                (0, k.Z)(function* () {
        ...
        return (
          ...
          (o.ɵcmp = t.Xpm({
            ...
            template: function (e, n) {
              1 & e &&
                (t.TgZ(0, "mat-card", 0),
                t.YNc(1, Gl, 13, 7, "div", 1),
                t.YNc(2, jl, 1, 0, "mat-divider", 2),
                t._UZ(3, "div", 3),
                t.TgZ(4, "div")(5, "h1", 4),
                ...
                t.TgZ(7, "mat-table", 5),
                t.ynx(8, 6),
                t.YNc(9, zl, 1, 0, "mat-header-cell", 7),
                t.YNc(10, Kl, 2, 1, "mat-cell", 8),
                t.BQk(),
                t.ynx(11, 9),
                t.YNc(12, Wl, 1, 0, "mat-header-cell", 10),
                t.YNc(13, $l, 3, 2, "mat-cell", 11),
                t.BQk(),
                t.ynx(14, 12),
                t.YNc(15, Vl, 1, 0, "mat-header-cell", 13),
                t.YNc(16, Xl, 2, 1, "mat-cell", 14),
                t.BQk(),
                t.ynx(17, 15),
                t.YNc(18, tc, 1, 0, "mat-header-cell", 16),
                t.YNc(19, ec, 3, 4, "mat-cell", 14),
                t.BQk(),
                t.YNc(20, oc, 1, 0, "mat-header-row", 17),
                t.YNc(21, nc, 1, 0, "mat-row", 18),
                t.qZA()(),
      ...
      const rc = (o) => {
        ...
        return new ic.y((i) => {
          e.addEventListener("loadend", () => {
            ...
            i.next(u ? null : { invalidMimeType: !0 }), i.complete();
          }),
        ...
        class o {
          ...
          addMemory(e, n) {
            ...
            return (
              i.append("image", n, e),
              i.append("caption", e),
              this.http.post(this.host, i).pipe(
                (0, _.U)((r) => r.data),
                (0, m.K)((r) => {
                  throw r;
                })
      ...
      function sc(o, a) {
        if (
          (1 & o &&
            (t.TgZ(0, "a", 10)(1, "button", 11), t._UZ(2, "i", 12), t.qZA()()),
          2 & o)
        ) {
          const e = t.oxw().$implicit,
            n = t.oxw(2);
      ...
      function cc(o, a) {
        if (
          (1 & o &&
            (t.TgZ(0, "div", 4), t.YNc(1, lc, 6, 4, "span", 5), t.qZA()),
          2 & o)
        ) {
          const e = t.oxw();
      ...
      function dc(o, a) {
        if (
          (1 & o && (t.TgZ(0, "div", 28), t._UZ(1, "img", 29), t.qZA()), 2 & o)
        ) {
          const e = t.oxw(2);
          t.xp6(1),
      ...
      function pc(o, a) {
        1 & o &&
          (t.TgZ(0, "mat-error", 17), t._uU(1), t.ALo(2, "translate"), t.qZA()),
          2 & o && (t.xp6(1), t.Oqu(t.lcZ(2, 1, "MANDATORY_CAPTION")));
      }
      function mc(o, a) {
        if (1 & o) {
          const e = t.EpF();
        ...
        if (2 & o) {
          ...
          t.xp6(4),
            ...
            t.Q6J(
              "disabled",
              e.form.get("image").invalid || e.form.get("caption").invalid
            ),
            t.xp6(3),
      ...
      let hc = (() => {
        class o {
          ...
          ngOnInit() {
            (this.slideshowDataSource = []),
              this.photoWallService.get().subscribe(
                (e) => {
                  var n;
                  this.emptyState = 0 === e.length;
                  for (const i of e)
                    !(null === (n = i.User) || void 0 === n) &&
                      n.username &&
                      (i.caption = `${i.caption} (\xa9 ${i.User.username})`),
                      this.slideshowDataSource.push({
                        url: i.imagePath,
                        caption: i.caption,
                      });
              ...
              this.configurationService.getApplicationConfiguration().subscribe(
                (e) => {
                  ...
                  null !== (n = null == e ? void 0 : e.application) &&
                    ...
                    e.application.social.twitterUrl &&
                    (this.twitterHandle =
                      e.application.social.twitterUrl.replace(
                        "https://twitter.com/",
                        "@"
                      ));
                },
          ...
          save() {
            this.photoWallService
              .addMemory(this.form.value.caption, this.form.value.image)
              .subscribe(
                () => {
                  this.resetForm(),
                    this.ngOnInit(),
        ...
        return (
          ...
          (o.ɵcmp = t.Xpm({
            ...
            template: function (e, n) {
              if (
                (1 & e &&
                  (t.TgZ(0, "mat-card", 0)(1, "h1"),
                  t._uU(2),
                  t.ALo(3, "translate"),
                  t.qZA(),
                  t.TgZ(4, "div"),
                  t.YNc(5, cc, 2, 1, "div", 1),
                  t.qZA(),
                  t.YNc(6, uc, 8, 0, "ng-template", null, 2, t.W1O),
                  t.YNc(8, mc, 22, 10, "div", 3),
                  t.qZA()),
                2 & e)
              ) {
                const i = t.MAs(7);
      ...
      function _c(o, a) {
        if (
          (1 & o &&
            (t.TgZ(0, "div", 22)(1, "div", 23)(2, "p", 24),
            t._uU(3),
            t.qZA()()()),
          2 & o)
        ) {
      ...
      const fc = function (o) {
        ...
        Cc = [
          { path: "administration", component: ua, canActivate: [Gt] },
          { path: "accounting", component: Vs, canActivate: [jt] },
          { path: "about", component: Po },
          ...
          { path: "delivery-method", component: ac },
          {
                      ...
                      (e) => {
                        ...
                        n &&
                          this.ngZone.runOutsideAngular(() => {
                            this.io
                              .socket()
                              .emit("verifySvgInjectionChallenge", n);
                          });
                      },
                      (e) => console.log(e)
                    ),
                ...
                (o.ɵcmp = t.Xpm({
                  ...
                  template: function (e, n) {
                    1 & e &&
                      ...
                      t.O4$(),
                      t.TgZ(4, "svg", 4),
                      t._UZ(5, "image", 5)(6, "image", 6)(7, "image", 7)(
                        8,
                        "image",
                        8
                      )(9, "image", 9)(10, "image", 10),
                      t.qZA()(),
                      t.kcU(),
                      ...
                      t.qZA()(),
                      t.YNc(18, gc, 7, 1, "div", 16),
                      t.qZA()(),
                      t.TgZ(19, "div", 17)(20, "mat-card", 18)(21, "div", 19)(
                        22,
                        "mat-icon",
                        20
                      ),
                      ...
                      t.qZA()()(),
                      t.TgZ(30, "mat-card", 18)(31, "div", 19)(
                        32,
                        "mat-icon",
                        20
                      ),
                      ...
                      t.qZA()()(),
                      t.TgZ(40, "mat-card", 18)(41, "div", 19)(
                        42,
                        "mat-icon",
                        20
                      ),
          ...
          { path: "saved-payment-methods", component: ys },
          { path: "basket", component: to },
          { path: "order-completion/:id", component: vl },
          { path: "contact", component: wo },
          { path: "photo-wall", component: hc },
          { path: "complain", component: wa },
          { path: "chatbot", component: ka },
          { path: "order-summary", component: Zl },
          { path: "order-history", component: Hl },
          { path: "payment/:entity", component: Ss },
          { path: "wallet", component: yl },
          { path: "login", component: On },
          { path: "forgot-password", component: en },
          { path: "recycle", component: ni },
          { path: "register", component: Qo },
          { path: "search", component: yt },
          { path: "hacking-instructor", component: yt },
          { path: "score-board", component: fr },
          { path: "track-result", component: Kt },
          ...
          { path: "2fa/enter", component: vr },
          {
            ...
            component: br,
            children: [
              { path: "privacy-policy", component: Pr },
              { path: "change-password", component: ga },
              { path: "two-factor-authentication", component: Zr },
              { path: "data-export", component: kr },
              { path: "last-login-ip", component: Or },
            ],
          },
          {
            ...
            data: {
              params: window.location.href.substr(
        ...
        if (2 & o) {
          ...
          t.s9C("checked", n.selectedLanguage === e),
            ...
            t.Tol(
              "fas fa-thermometer-" +
                e.gauge +
                (e.percentage > 70 ? " confirmation" : " error")
            );
        }
      }
      function Ec(o, a) {
        1 & o &&
          (t.TgZ(0, "button", 49)(1, "mat-icon"),
          t._uU(2, " my_location "),
          t.qZA(),
          t.TgZ(3, "span"),
          t._uU(4),
          ...
          t.qZA()()),
          2 & o &&
            (t.xp6(4), t.hij(" ", t.lcZ(5, 1, "MY_SAVED_ADRESSES"), " "));
      }
      function qc(o, a) {
        1 & o &&
          (t.TgZ(0, "button", 50)(1, "mat-icon"),
          t._uU(2, " credit_card "),
          t.qZA(),
          t.TgZ(3, "span"),
          t._uU(4),
          ...
          t.qZA()()),
          2 & o &&
            (t.xp6(4), t.hij(" ", t.lcZ(5, 1, "MY_PAYMENT_OPTIONS"), " "));
      }
      function Mc(o, a) {
        1 & o &&
          (t.TgZ(0, "button", 51)(1, "mat-icon"),
        ...
        class o {
              ...
              this.configurationService.getApplicationConfiguration().subscribe(
                (e) => {
                  ...
                  if (
                    ...
                    null != e &&
                      e.application &&
                      (this.showGitHubLink = e.application.showGitHubLinks),
                    null !== (i = null == e ? void 0 : e.application) &&
                      void 0 !== i &&
                      i.logo)
                  ) {
          ...
          changeLanguage(e) {
            ...
            if (
              ...
              this.cookieService.put("language", e, { expires: n }),
              ...
              (this.shortKeyLang = i.shortKey),
                this.snackBar
                  .open(
                    `Language has been changed to ${i.lang}`,
                    "Force page reload",
                    { duration: 5e3 }
                  )
                  .onAction()
        ...
        return (
          ...
          (o.ɵcmp = t.Xpm({
            ...
            template: function (e, n) {
              if (1 & e) {
                const i = t.EpF();
                t.TgZ(0, "mat-toolbar", 0)(1, "mat-toolbar-row", 1)(
                  2,
                  "button",
                  2
                ),
                  ...
                  t.YNc(21, Sc, 6, 3, "button", 12),
                  t.YNc(22, yc, 5, 1, "button", 13),
                  t.YNc(23, Ic, 6, 3, "button", 14),
                  t.YNc(24, Uc, 6, 4, "button", 15),
                  t.YNc(25, kc, 6, 4, "button", 16),
                  t.YNc(26, Oc, 6, 3, "button", 17),
                  t.qZA(),
                  t.YNc(27, Pc, 8, 4, "button", 18),
                  t.TgZ(28, "button", 19),
                  t.ALo(29, "translate"),
                  t.TgZ(30, "mat-icon"),
                  t._uU(31, " language "),
                  ...
                  t.YNc(36, Nc, 5, 7, "mat-radio-button", 23),
                  t.qZA(),
                  t.TgZ(37, "mat-menu", null, 24)(39, "button", 25)(
                    40,
                    "mat-icon"
                  ),
                  t._uU(41, " assignment "),
                  ...
                  t.qZA()()(),
                  t.TgZ(70, "mat-menu", null, 32)(72, "button", 33)(
                    73,
                    "mat-icon"
                  ),
                  t._uU(74, " archive "),
                  ...
                  t.YNc(85, Ec, 6, 3, "button", 35),
                  t.YNc(86, qc, 6, 3, "button", 36),
                  t.YNc(87, Mc, 6, 3, "button", 37),
                  t.qZA()()();
              }
              if (2 & e) {
                const i = t.MAs(20),
                ...
                t.xp6(2),
                  ...
                  t.xp6(3),
                  t.Q6J("routerLink", t.DdM(38, Dc)),
                  t.xp6(5),
                  t.Q6J("routerLink", t.DdM(39, Fc)),
                  t.xp6(11),
                  t.Q6J("routerLink", t.DdM(40, Rc)),
                  t.xp6(5),
                  t.Q6J("routerLink", t.DdM(41, Yc)),
                  t.xp6(5),
                  t.Q6J("routerLink", t.DdM(42, Bc)),
                  t.xp6(11),
      ...
      function Qc(o, a) {
        ...
        2 & o &&
          t.Q6J("matTooltip", t.lcZ(1, 1, "SCORE_BOARD_HACKING_INSTRUCTOR"));
      }
      function Hc(o, a) {
        if (1 & o) {
          const e = t.EpF();
      ...
      let Gc = (() => {
          class o {
              ...
              this.configurationService.getApplicationConfiguration().subscribe(
                (e) => {
                  ...
                  !(
                    ...
                    n.welcomeBanner &&
                    ((this.title = e.application.welcomeBanner.title),
                    (this.message = e.application.welcomeBanner.message)),
                    (this.showHackingInstructor =
                      null === (i = null == e ? void 0 : e.hackingInstructor) ||
                      void 0 === i
                        ? void 0
                        : i.isEnabled),
                    this.showHackingInstructor &&
                      (null === (r = null == e ? void 0 : e.challenges) ||
                      void 0 === r
                        ? void 0
                        : r.restrictToTutorialsFirst) &&
            ...
            startHackingInstructor() {
              this.closeWelcome(),
                console.log(
                  'Starting instructions for challenge "Score Board"'
                ),
                d
                  .e(648)
                  .then(d.bind(d, 3907))
          ...
          return (
            ...
            (o.ɵcmp = t.Xpm({
              ...
              template: function (e, n) {
                1 & e &&
                  (t.TgZ(0, "div", 0)(1, "h1")(2, "span"),
                  t._uU(3),
                  t.qZA()(),
                  t._UZ(4, "div", 1),
                  t.TgZ(5, "div"),
                  t.YNc(6, Qc, 6, 3, "button", 2),
                  t.YNc(7, Hc, 5, 0, "button", 3),
                  t.qZA()()),
                  2 & e &&
                    (t.xp6(3),
                    t.Oqu(n.title),
              ...
              styles: [
                ".text-justify[_ngcontent-%COMP%]{text-align:justify;text-justify:inter-word}[_nghost-%COMP%]     h1 a{font-size:20px}[_nghost-%COMP%]     strong{font-style:italic}",
              ],
            })),
            o
          );
        ...
        jc = (() => {
          class o {
            ...
            ngOnInit() {
              "dismiss" !==
                this.cookieService.get(this.welcomeBannerStatusCookieKey) &&
                this.configurationService
                  .getApplicationConfiguration()
                  .subscribe(
                    (n) => {
                      ...
                      void 0 === i
                        ? void 0
                        : i.welcomeBanner) &&
                        !n.application.welcomeBanner.showOnFirstStart) ||
                        this.dialog.open(Gc, {
                          minWidth: "320px",
                          width: "35%",
                          position: { top: "50px" },
          ...
          return (
            ...
            (o.ɵcmp = t.Xpm({
              ...
              styles: [
                ".welcome-style[_ngcontent-%COMP%]   .mat-dialog-container[_ngcontent-%COMP%]{margin-left:auto;margin-right:auto;max-width:50%;min-width:320px}",
              ],
            })),
            o
          );
      ...
      function Kc(o, a) {
        1 & o &&
          (t.TgZ(0, "span", 2), t._uU(1, "RESET_HACKING_PROGRESS"), t.qZA());
      }
      function Wc(o, a) {
        if (1 & o) {
          const e = t.EpF();
          t.TgZ(0, "mat-card", 1),
            ...
            t.qZA(),
            t.YNc(11, zc, 2, 0, "span", 5),
            t.YNc(12, Kc, 2, 0, "span", 5),
            t.qZA()()();
        }
        if (2 & o) {
          const e = t.oxw();
            ...
            ngOnInit() {
              this.ngZone.runOutsideAngular(() => {
                this.io.socket().on("server started", () => {
                  ...
                  e &&
                    this.challengeService
                      .restoreProgress(encodeURIComponent(e))
                      .subscribe(
                        () => {
                          this.translate
                            .get("AUTO_RESTORED_PROGRESS")
                            .subscribe(
                              (r) => {
                        ...
                        (r) => {
                          console.log(r),
                            this.translate
                              .get("AUTO_RESTORE_PROGRESS_FAILED", { error: r })
                              .subscribe(
                                (l) => {
                    ...
                    n &&
                      this.challengeService
                        .restoreProgressFindIt(encodeURIComponent(n))
                        .subscribe(
                          () => {},
                          (r) => {
                            console.log(r);
                    ...
                    i &&
                      this.challengeService
                        .restoreProgressFixIt(encodeURIComponent(i))
                        .subscribe(
                          () => {},
                          (r) => {
                            console.log(r);
          ...
          return (
            ...
            (o.ɵcmp = t.Xpm({
              ...
              consts: [
                [
                  "class",
                  "container primary-notification mat-elevation-z4",
                  4,
                  "ngIf",
                ],
              ...
              template: function (e, n) {
                1 & e && t.YNc(0, Wc, 13, 4, "mat-card", 0),
      ...
      function ou(o, a) {
        if (
          (1 & o &&
            (t.TgZ(0, "span", 5),
            t.YNc(1, Xc, 2, 5, "span", 8),
            t.YNc(2, tu, 2, 0, "mat-icon", 9),
            t._uU(3, "\xa0 "),
            t.YNc(4, eu, 2, 1, "span", 9),
            t.qZA()),
          2 & o)
        ) {
          const e = t.oxw(2);
          t.xp6(1),
            t.Q6J(
              "ngIf",
              "flag" === e.showCtfCountryDetailsInNotifications ||
                "both" === e.showCtfCountryDetailsInNotifications
            ),
            t.xp6(1),
            ...
            t.Q6J(
              "ngIf",
              "name" === e.showCtfCountryDetailsInNotifications ||
                "both" === e.showCtfCountryDetailsInNotifications
            );
        }
      }
      ...
      let au = (() => {
        class o {
          ...
          ngOnInit() {
            this.ngZone.runOutsideAngular(() => {
              this.io.socket().on("challenge solved", (e) => {
                null != e &&
                  e.challenge &&
                  (e.hidden || this.showNotification(e),
                  e.isRestore ||
                    (this.saveProgress(),
                    d
                      .e(103)
              ...
              this.configurationService
                ...
                .subscribe((e) => {
                  null != e &&
                    e.ctf &&
                    ((this.showCtfFlagsInNotifications =
                      !!e.ctf.showFlagsInNotifications &&
                      e.ctf.showFlagsInNotifications),
                    e.ctf.showCountryDetailsInNotifications
                      ? ((this.showCtfCountryDetailsInNotifications =
                          e.ctf.showCountryDetailsInNotifications),
                        "none" !== e.ctf.showCountryDetailsInNotifications &&
                          this.countryMappingService
                            .getCountryMapping()
                            .subscribe(
                              (n) => {
                                this.countryMap = n;
          ...
          showNotification(e) {
            this.translate
              .get("CHALLENGE_SOLVED", { challenge: e.challenge })
              .toPromise()
              .then(
                (n) => n,
                (n) => n
              ...
              .then((n) => {
                let i;
                this.showCtfCountryDetailsInNotifications &&
                  "none" !== this.showCtfCountryDetailsInNotifications &&
                  (i = this.countryMap[e.key]),
          ...
          saveProgress() {
            this.challengeService.continueCode().subscribe(
              (e) => {
                ...
                const n = new Date();
                n.setFullYear(n.getFullYear() + 1),
                  this.cookieService.put("continueCode", e, { expires: n });
              },
              (e) => console.log(e)
            );
          }
        ...
        return (
          ...
          (o.ɵcmp = t.Xpm({
            ...
            template: function (e, n) {
              1 & e &&
                (t.TgZ(0, "div", 0),
                t.YNc(1, nu, 23, 14, "mat-card", 1),
                t.qZA()),
                2 & e && (t.xp6(1), t.Q6J("ngForOf", n.notifications));
            },
            dependencies: [T.sg, T.O5, Ze.yb, O.Hw, A.lW, x.a8, T.i8, p.X$],
            styles: [
              ".container[_ngcontent-%COMP%]{font-size:14px;margin:40px}mat-card[_ngcontent-%COMP%]{margin-bottom:10px}#closeButton[_ngcontent-%COMP%]{float:right}.icon-box[_ngcontent-%COMP%]{display:inline-flex;vertical-align:middle}",
            ],
          })),
          o
        );
      ...
      function lu(o, a) {
        ...
        if (2 & o) {
          ...
          t.xp6(4),
            t.hij(" ", t.lcZ(5, 2, "ORDERS_AND_PAYMENT"), " "),
            t.xp6(2),
            t.Q6J("ngClass", t.VKq(4, Se, e.showOrdersSubmenu));
        }
      }
      function cu(o, a) {
        if (1 & o) {
        ...
        2 & o &&
          (t.xp6(4), t.hij(" ", t.lcZ(5, 1, "LABEL_ORDER_HISTORY"), " "));
      }
      function uu(o, a) {
        if (1 & o) {
          const e = t.EpF();
      ...
      function hu(o, a) {
        if (
          ...
          const e = t.oxw();
          t.Q6J("ngClass", t.VKq(6, ye, e.showOrdersSubmenu)),
            t.xp6(1),
      ...
      function _u(o, a) {
        ...
        if (2 & o) {
          ...
          t.xp6(4),
            t.hij(" ", t.lcZ(5, 2, "PRIVACY_AND_SECURITY"), " "),
            t.xp6(2),
            t.Q6J("ngClass", t.VKq(4, Se, e.showPrivacySubmenu));
        }
      }
      function gu(o, a) {
        if (1 & o) {
      ...
      function xu(o, a) {
        if (
          ...
          const e = t.oxw();
          t.Q6J("ngClass", t.VKq(7, ye, e.showPrivacySubmenu)),
            t.xp6(1),
            t.Q6J("ngIf", e.isLoggedIn()),
            t.xp6(1),
            t.Q6J("ngIf", e.isLoggedIn()),
      ...
      function wu(o, a) {
        ...
        2 & o &&
          (t.xp6(4), t.hij(" ", t.lcZ(5, 1, "SECTION_SUPPORT_CHAT"), " "));
      }
      function Su(o, a) {
        if (1 & o) {
          const e = t.EpF();
        ...
        2 & o &&
          (t.xp6(4), t.hij(" ", t.lcZ(5, 1, "LABEL_DELUXE_MEMBERSHIP"), " "));
      }
      function yu(o, a) {
      ...
      function Uu(o, a) {
        ...
        2 & o &&
          (t.xp6(4), t.hij(" ", t.lcZ(5, 1, "BTN_GETTING_STARTED"), " "));
      }
      function ku(o, a) {
        1 & o &&
          (t.TgZ(0, "a", 74),
      ...
      let Ou = (() => {
              ...
              this.configurationService.getApplicationConfiguration().subscribe(
                (e) => {
                  ...
                  !(
                    ...
                    (null == e
                      ? void 0
                      : e.application.welcomeBanner.showOnFirstStart) &&
                      e.hackingInstructor.isEnabled &&
                      (this.offerScoreBoardTutorial =
                        e.application.welcomeBanner.showOnFirstStart &&
                        e.hackingInstructor.isEnabled);
                },
                (e) => console.log(e)
          ...
          return (
            ...
            (o.ɵcmp = t.Xpm({
              ...
              template: function (e, n) {
                1 & e &&
                  (t.TgZ(0, "mat-toolbar", 0)(1, "mat-toolbar-row")(2, "h2"),
                  t._uU(3),
                  t.qZA()()(),
                  ...
                  t.YNc(10, ru, 5, 1, "a", 5),
                  t.YNc(11, su, 6, 3, "a", 6),
                  t.YNc(12, lu, 8, 6, "mat-list-item", 7),
                  t.YNc(13, hu, 7, 8, "div", 8),
                  t.YNc(14, _u, 8, 6, "mat-list-item", 9),
                  t.YNc(15, xu, 8, 9, "div", 8),
                  t.YNc(16, Au, 6, 3, "a", 10),
                  t.qZA(),
                  ...
                  t.ALo(25, "translate"),
                  t.qZA()(),
                  t.YNc(26, Zu, 6, 3, "a", 15),
                  t.YNc(27, wu, 6, 3, "a", 16),
                  ...
                  t.ALo(42, "translate"),
                  t.qZA()(),
                  t.YNc(43, Su, 6, 3, "a", 19),
                  t.YNc(44, yu, 1, 0, "mat-divider", 20),
                  t.YNc(45, Iu, 5, 3, "a", 21),
                  t.YNc(46, Uu, 6, 3, "a", 22),
                  t.YNc(47, ku, 4, 0, "a", 23),
                  t.qZA(),
                  ...
                  2 & e &&
                    ...
                    t.Q6J(
                      "ngIf",
                      !n.scoreBoardVisible && n.offerScoreBoardTutorial
                    ),
                    t.xp6(1),
          ...
          return (
            ...
            (o.ɵcmp = t.Xpm({
              ...
              template: function (e, n) {
                if (1 & e) {
                  const i = t.EpF();
                  t.TgZ(0, "div", 0)(1, "mat-sidenav-container", 1)(
                    2,
                    "mat-sidenav",
                    2,
                    3
                    ...
                    t.qZA(),
                    t._UZ(6, "app-server-started-notification")(
                      7,
                      "app-challenge-solved-notification"
                    )(8, "app-welcome")(9, "router-outlet"),
                    t.qZA()();
                }
              },
      ...
      let Du = (() => {
          ...
          constructor(e, n) {
            (this.configurationService = e),
              ...
              e.getApplicationConfiguration().subscribe((i) => {
                n.getContainerElement().classList.add(
                  i.application.theme + "-theme"
                );
              });
          }
        }
        return (
          ...
          (o.ɵmod = t.oAB({ type: o, bootstrap: [Pu] })),
          (o.ɵinj = t.cJS({
            providers: [
              { provide: I.TP, useClass: Lu, multi: !0 },
              {
                provide: Pt.rN,
                useValue: {
                  coreLibraryLoader:
            ...
            imports: [
              ...
              vc,
              p.aw.forRoot({
                loader: { provide: p.Zw, useFactory: Mu, deps: [I.eN] },
              }),
              q.m$.forRoot(),
              rt.tw.forRoot(),
              Nu.o9,
